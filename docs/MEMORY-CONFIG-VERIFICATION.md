...
- Set **`DB_PATH`** in the environment (or in **Config → Environment → custom env vars**) to the **full path** to your `powerdirector.db` (e.g. `/home/jcavallarojr/powerdirector/powerdirector.db`).
