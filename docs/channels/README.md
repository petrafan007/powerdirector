...
This directory documents the channel architecture migration from PowerDirector to PowerDirector.
...
This architecture was migrated from PowerDirector to PowerDirector:

- All channel implementations copied from `powerdirector-source/src/X/`
- All shared utilities copied from `powerdirector-source/src/channels/`
- All plugin system files copied from `powerdirector-source/src/channels/plugins/`
- All references updated from `powerdirector` to `powerdirector`
