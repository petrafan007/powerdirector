...
- Keep product names in English: PowerDirector, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the PowerDirector Gateway, use “Gateway 网关”.
