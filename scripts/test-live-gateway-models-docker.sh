...
docker run --rm -t \
  ...
  -e POWERDIRECTOR_LIVE_GATEWAY_MODELS="${POWERDIRECTOR_LIVE_GATEWAY_MODELS:-${CLAWDBOT_LIVE_GATEWAY_MODELS:-all}}" \
  -e POWERDIRECTOR_LIVE_GATEWAY_PROVIDERS="${POWERDIRECTOR_LIVE_GATEWAY_PROVIDERS:-${CLAWDBOT_LIVE_GATEWAY_PROVIDERS:-}}" \
  -e POWERDIRECTOR_LIVE_GATEWAY_MODEL_TIMEOUT_MS="${POWERDIRECTOR_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-${CLAWDBOT_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-}}" \
