...
if [[ -z "$version_content" ]]; then
  echo "<h2>PowerDirector $VERSION</h2>"
  echo "<p>Latest PowerDirector update.</p>"
  echo "<p><a href=\"https://github.com/powerdirector/powerdirector/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
