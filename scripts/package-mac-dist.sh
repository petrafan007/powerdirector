...
#
# Output:
# - dist/PowerDirector.app
# - dist/PowerDirector-<version>.zip
# - dist/PowerDirector-<version>.dmg
...
APP="$ROOT_DIR/dist/PowerDirector.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/PowerDirector-$VERSION.zip"
DMG="$ROOT_DIR/dist/PowerDirector-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/PowerDirector-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/PowerDirector-$VERSION.dSYM.zip"
