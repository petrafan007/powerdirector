...
let originalPowerDirectorTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalPowerDirectorTestConsole = process.env.POWERDIRECTOR_TEST_CONSOLE;
...
afterEach(() => {
  ...
  if (originalPowerDirectorTestConsole === undefined) {
    delete process.env.POWERDIRECTOR_TEST_CONSOLE;
  } else {
    process.env.POWERDIRECTOR_TEST_CONSOLE = originalPowerDirectorTestConsole;
  }
