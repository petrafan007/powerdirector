...
describe("buildLineMessageContext", () => {
  ...
  beforeEach(async () => {
    tmpDir = await fs.mkdtemp(path.join(((typeof ((typeof os.tmpdir === "function") ? os.tmpdir : (() => "/tmp")) === "function") ? ((typeof os.tmpdir === "function") ? os.tmpdir : (() => "/tmp"))() : "/tmp"), "powerdirector-line-context-"));
  ...
  it("group peer binding matches raw groupId without prefix (#21907)", async () => {
    ...
    const bindingCfg: PowerDirectorConfig = {
