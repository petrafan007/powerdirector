import * as bluebubblesSdk from "powerdirector/plugin-sdk/bluebubbles";
import * as channelPairingSdk from "powerdirector/plugin-sdk/channel-pairing";
import * as channelReplyPipelineSdk from "powerdirector/plugin-sdk/channel-reply-pipeline";
import * as channelRuntimeSdk from "powerdirector/plugin-sdk/channel-runtime";
import * as channelSendResultSdk from "powerdirector/plugin-sdk/channel-send-result";
import * as channelSetupSdk from "powerdirector/plugin-sdk/channel-setup";
import * as coreSdk from "powerdirector/plugin-sdk/core";
import type {
  ChannelMessageActionContext as CoreChannelMessageActionContext,
  PowerDirectorPluginApi as CorePowerDirectorPluginApi,
  PluginRuntime as CorePluginRuntime,
} from "powerdirector/plugin-sdk/core";
import * as directoryRuntimeSdk from "powerdirector/plugin-sdk/directory-runtime";
import * as discordSdk from "powerdirector/plugin-sdk/discord";
import * as imessageSdk from "powerdirector/plugin-sdk/imessage";
import * as imessageCoreSdk from "powerdirector/plugin-sdk/imessage-core";
import * as lazyRuntimeSdk from "powerdirector/plugin-sdk/lazy-runtime";
import * as ollamaSetupSdk from "powerdirector/plugin-sdk/ollama-setup";
import * as providerModelsSdk from "powerdirector/plugin-sdk/provider-models";
import * as providerSetupSdk from "powerdirector/plugin-sdk/provider-setup";
import * as replyPayloadSdk from "powerdirector/plugin-sdk/reply-payload";
import * as routingSdk from "powerdirector/plugin-sdk/routing";
import * as runtimeSdk from "powerdirector/plugin-sdk/runtime";
import * as sandboxSdk from "powerdirector/plugin-sdk/sandbox";
import * as secretInputSdk from "powerdirector/plugin-sdk/secret-input";
import * as selfHostedProviderSetupSdk from "powerdirector/plugin-sdk/self-hosted-provider-setup";
import * as setupSdk from "powerdirector/plugin-sdk/setup";
import * as slackSdk from "powerdirector/plugin-sdk/slack";
import * as telegramSdk from "powerdirector/plugin-sdk/telegram";
import * as testingSdk from "powerdirector/plugin-sdk/testing";
import * as webhookIngressSdk from "powerdirector/plugin-sdk/webhook-ingress";
import * as whatsappSdk from "powerdirector/plugin-sdk/whatsapp";
import * as whatsappActionRuntimeSdk from "powerdirector/plugin-sdk/whatsapp-action-runtime";
import * as whatsappLoginQrSdk from "powerdirector/plugin-sdk/whatsapp-login-qr";
import { describe, expect, expectTypeOf, it } from "vitest";
import type { ChannelMessageActionContext } from "../channels/plugins/types.js";
import type { PluginRuntime } from "../plugins/runtime/types.js";
import type { PowerDirectorPluginApi } from "../plugins/types.js";
import type {
  ChannelMessageActionContext as SharedChannelMessageActionContext,
  PowerDirectorPluginApi as SharedPowerDirectorPluginApi,
...
const bundledExtensionSubpathLoaders = pluginSdkSubpaths.map((id: string) => ({
  id,
  load: () => importPluginSdkSubpath(`powerdirector/plugin-sdk/${id}`),
}));

const asExports = (mod: object) => mod as Record<string, unknown>;
const accountHelpersSdk = await import("powerdirector/plugin-sdk/account-helpers");
const allowlistEditSdk = await import("powerdirector/plugin-sdk/allowlist-config-edit");
...
describe("plugin-sdk subpath exports", () => {
  ...
  it("exports shared core types used by bundled channels", () => {
    expectTypeOf<CorePowerDirectorPluginApi>().toMatchTypeOf<PowerDirectorPluginApi>();
  ...
  it("keeps core shared types aligned with the channel prelude", () => {
    expectTypeOf<CorePowerDirectorPluginApi>().toMatchTypeOf<SharedPowerDirectorPluginApi>();
