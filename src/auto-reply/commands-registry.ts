...
function resolveDefaultCommandContext(cfg?: PowerDirectorConfig): {
  provider: string;
  model: string;
} {
...
export function getCommandDetection(_cfg?: PowerDirectorConfig): CommandDetection {
  const commands = getChatCommands();
...
export function maybeResolveTextAlias(raw: string, cfg?: PowerDirectorConfig) {
