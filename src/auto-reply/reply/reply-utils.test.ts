  ...
  it("resolves known variables, aliases, and case-insensitive tokens", () => {
    const cases = [
      ...
      },
      {
        ...
        values: { identityName: "PowerDirector" },
        expected: "[PowerDirector]",
      },
      {
      ...
      },
      {
        ...
        values: {
          identityName: "PowerDirector",
          provider: "anthropic",
          model: "claude-opus-4-5",
          thinkingLevel: "high",
        },
        expected: "[PowerDirector] anthropic/claude-opus-4-5 (think:high)",
      },
    ] as const;
