...
export async function drainFormattedSystemEvents(params: {
  ...
  const resolveSystemEventTimezone = (cfg: PowerDirectorConfig) => {
  ...
  const formatSystemEventTimestamp = (ts: number, cfg: PowerDirectorConfig) => {
...
export async function ensureSkillSnapshot(params: {
  ...
  if (process.env.POWERDIRECTOR_TEST_FAST === "1") {
