...
const MISSING_EXTENSIONS_ERROR =
  'package.json missing powerdirector.extensions; update the plugin package to include powerdirector.extensions (for example ["./dist/index.js"]). See https://docs.powerdirector.ai/help/troubleshooting#plugin-install-fails-with-missing-powerdirector-extensions';
