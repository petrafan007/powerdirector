...
export const normalizePluginsConfig = (
  config?: PowerDirectorConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: PowerDirectorConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: PowerDirectorConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: PowerDirectorConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
