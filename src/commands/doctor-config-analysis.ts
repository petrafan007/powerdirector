...
import { PowerDirectorSchema } from "../config/zod-schema.js";
...
export function stripUnknownConfigKeys(config: PowerDirectorConfig): {
...
export function noteOpencodeProviderOverrides(cfg: PowerDirectorConfig): void {
