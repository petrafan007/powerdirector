...
async function withOnboardEnv(
  ...
  const prev = captureEnv([
    ...
    "POWERDIRECTOR_SKIP_CHANNELS",
    "POWERDIRECTOR_SKIP_GMAIL_WATCHER",
    "POWERDIRECTOR_SKIP_CRON",
    "POWERDIRECTOR_SKIP_CANVAS_HOST",
    "POWERDIRECTOR_GATEWAY_TOKEN",
    "POWERDIRECTOR_GATEWAY_PASSWORD",
    "CUSTOM_API_KEY",
    "POWERDIRECTOR_DISABLE_CONFIG_CACHE",
  ]);
  ...
  process.env.POWERDIRECTOR_DISABLE_CONFIG_CACHE = "1";
