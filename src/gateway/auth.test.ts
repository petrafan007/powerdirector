...
describe("gateway auth", () => {
  ...
  it("resolves token/password from POWERDIRECTOR gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          POWERDIRECTOR_GATEWAY_TOKEN: "env-token",
          POWERDIRECTOR_GATEWAY_PASSWORD: "env-password",
    ...
    expect(
      resolveGatewayAuth({
        authConfig: {
          ...
          password: "${POWERDIRECTOR_GATEWAY_PASSWORD}",
        },
        env: {
          POWERDIRECTOR_GATEWAY_TOKEN: "env-token",
          POWERDIRECTOR_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides POWERDIRECTOR_GATEWAY_PASSWORD", () => {
