...
export function hasAmbiguousGatewayAuthModeConfig(cfg: PowerDirectorConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: PowerDirectorConfig): void {
