...
const EMPTY_CFG = {} as PowerDirectorConfig;
...
async function applySubagentModelPatch(cfg: PowerDirectorConfig) {
...
function createAllowlistedAnthropicModelCfg(): PowerDirectorConfig {
  return {
    agents: {
      defaults: {
