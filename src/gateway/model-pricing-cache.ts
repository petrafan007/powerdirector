...
export function collectConfiguredModelPricingRefs(config: PowerDirectorConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: PowerDirectorConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
