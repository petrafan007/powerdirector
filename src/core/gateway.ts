...
import { BindingsManager, BindingResolution } from './bindings.js';
import { BroadcastManager } from './broadcast.js';
import { CanvasHostManager } from './canvas-host.js';
import { DiscoveryManager } from './discovery.js';
import { HooksManager } from './hooks.js';
import { MediaManager } from './media.js';
import { MemoryManager } from './memory.js';
import { TalkManager } from './talk.js';
import { TerminalManager, type TerminalRuntimeOptions } from './terminal.js';
import { AutoReplyManager, type AutoReplyDecision } from './auto-reply.js';
...
export class Gateway {
    ...
    public async processInput(
        ...
        const sessionMetadata = sessionStore?.metadata || {};
