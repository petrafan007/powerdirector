...
describe("workspace bootstrap file caching", () => {
  ...
  beforeEach(async () => {
    workspaceDir = await makeTempWorkspace("powerdirector-bootstrap-cache-test-");
  });
  ...
  it("caches files independently by path", async () => {
    ...
    const workspace1 = await makeTempWorkspace("powerdirector-cache-test1-");
    const workspace2 = await makeTempWorkspace("powerdirector-cache-test2-");
