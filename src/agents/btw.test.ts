...
const ensurePowerDirectorModelsJsonMock = vi.fn();
...
vi.mock("./models-config.js", () => ({
  ensurePowerDirectorModelsJson: (...args: unknown[]) => ensurePowerDirectorModelsJsonMock(...args),
}));
...
describe("runBtwSideQuestion", () => {
  beforeEach(() => {
    ...
    ensurePowerDirectorModelsJsonMock.mockReset();
