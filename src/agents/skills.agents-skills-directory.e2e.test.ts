...
describe("buildWorkspaceSkillsPrompt — .agents/skills/ directories", () => {
  ...
  beforeEach(async () => {
    fakeHome = await fs.mkdtemp(path.join(((typeof ((typeof os.tmpdir === "function") ? os.tmpdir : (() => "/tmp")) === "function") ? ((typeof os.tmpdir === "function") ? os.tmpdir : (() => "/tmp"))() : "/tmp"), "powerdirector-home-"));
