...
describe("subagent announce formatting", () => {
  ...
  beforeAll(async () => {
    ...
    // See: https://github.com/powerdirector/powerdirector/issues/31298
    previousFastTestEnv = process.env.POWERDIRECTOR_TEST_FAST;
  ...
  beforeEach(() => {
    // POWERDIRECTOR_TEST_FAST is set in beforeAll before module import
  ...
  it("sends instructional message to main agent with status and findings", async () => {
    ...
    expect(msg).toContain("PowerDirector runtime context (internal):");
