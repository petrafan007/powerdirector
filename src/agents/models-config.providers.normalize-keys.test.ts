...
describe("normalizeProviders", () => {
  ...
  it("ignores non-object provider entries during source-managed enforcement", () => {
    ...
    } as unknown as NonNullable<NonNullable<PowerDirectorConfig["models"]>["providers"]>;

    const sourceProviders: NonNullable<NonNullable<PowerDirectorConfig["models"]>["providers"]> = {
      openai: {
        baseUrl: "https://api.openai.com/v1",
        api: "openai-completions",
