...
function resolveAnthropicOpusThinking(cfg: PowerDirectorConfig) {
...
function createProviderWithModelsConfig(provider: string, models: Array<Record<string, unknown>>) {
  ...
  } as Partial<PowerDirectorConfig>;
}

function resolveConfiguredRefForTest(cfg: Partial<PowerDirectorConfig>) {
...
describe("model-selection", () => {
  ...
  describe("buildModelAliasIndex", () => {
    it("should build alias index from config", () => {
      const cfg: Partial<PowerDirectorConfig> = {
        agents: {
          defaults: {
            models: {
