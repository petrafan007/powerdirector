...
function resolveWatchPaths(workspaceDir: string, config?: PowerDirectorConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: PowerDirectorConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: PowerDirectorConfig }) {
