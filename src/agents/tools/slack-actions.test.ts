...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): PowerDirectorConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: PowerDirectorConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: PowerDirectorConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
