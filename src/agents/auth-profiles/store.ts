 ...
 * A common mistake — caused by the similarity with the `powerdirector.config.json`
...
function normalizeRawCredentialEntry(raw: Record<string, unknown>): Partial<AuthProfileCredential> {
  ...
  // mode → type alias (powerdirector.config.json uses "mode"; auth-profiles.json uses "type")
