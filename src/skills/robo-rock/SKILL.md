---
name: roborock
description: Control Roborock robot vacuums (status, clean, maps, consumables). Use when asked to start vacuum, vacuum specific rooms/routines, check vacuum status, or manage cleaning schedules. Triggers on vacuum, roborock, clean floor, hoover, robot cleaner, start vacuum, vacuum main, mop and vacuum keywords.
metadata: {"powerdirector":{"emoji":"🧹","requires":{"bins":["roborock"]},"install":[{"id":"pipx","kind":"pipx","package":"python-roborock","bins":["roborock"],"label":"Install roborock CLI (pipx)"}]}}
---
