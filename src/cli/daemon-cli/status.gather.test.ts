...
const serviceReadCommand = vi.fn(async (_env?: NodeJS.ProcessEnv) => ({
  ...
  environment: {
    ...
    POWERDIRECTOR_CONFIG_PATH: "/tmp/powerdirector-daemon/powerdirector.config.json",
  },
}));
...
const resolveConfigPath = vi.fn((env: NodeJS.ProcessEnv, stateDir: string) => {
  return env.POWERDIRECTOR_CONFIG_PATH ?? `${stateDir}/powerdirector.config.json`;
});
...
describe("gatherDaemonStatus", () => {
  ...
  beforeEach(() => {
    ...
    process.env.POWERDIRECTOR_CONFIG_PATH = "/tmp/powerdirector-cli/powerdirector.config.json";
