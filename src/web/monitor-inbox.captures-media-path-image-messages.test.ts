...
describe("web monitor inbox", () => {
  ...
  it("logs inbound bodies to file", async () => {
    const logPath = path.join(((typeof ((typeof os.tmpdir === "function") ? os.tmpdir : (() => "/tmp")) === "function") ? ((typeof os.tmpdir === "function") ? os.tmpdir : (() => "/tmp"))() : "/tmp"), `powerdirector-log-test-${crypto.randomUUID()}.log`);
