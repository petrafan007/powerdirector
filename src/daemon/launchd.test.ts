...
function expectLaunchctlEnableBootstrapOrder(env: Record<string, string | undefined>) {
  ...
  const label = "ai.powerdirector.gateway";
...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.powerdirector.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", POWERDIRECTOR_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.powerdirector.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when POWERDIRECTOR_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.powerdirector.gateway.plist",
    },
    {
      name: "uses profile-specific label when POWERDIRECTOR_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", POWERDIRECTOR_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.powerdirector.jbphoenix.plist",
    },
    {
      name: "prefers POWERDIRECTOR_LAUNCHD_LABEL over POWERDIRECTOR_PROFILE",
      env: {
        HOME: "/Users/test",
        POWERDIRECTOR_PROFILE: "jbphoenix",
        POWERDIRECTOR_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from POWERDIRECTOR_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        POWERDIRECTOR_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty POWERDIRECTOR_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        POWERDIRECTOR_PROFILE: "myprofile",
        POWERDIRECTOR_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.powerdirector.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
