...
export function triggerPowerDirectorRestart(): RestartAttempt {
  ...
  if (process.platform === "linux") {
    const unit = normalizeSystemdUnit(
      process.env.POWERDIRECTOR_SYSTEMD_UNIT,
      process.env.POWERDIRECTOR_PROFILE,
    );
  ...
  const label =
    process.env.POWERDIRECTOR_LAUNCHD_LABEL ||
    resolveGatewayLaunchAgentLabel(process.env.POWERDIRECTOR_PROFILE);
  ...
  const home = process.env.HOME?.trim() || ((typeof ((typeof os.homedir === "function") ? os.homedir : (() => "")) === "function") ? ((typeof ((typeof os.homedir === "function") ? os.homedir : (() => "")) === "function") ? ((typeof os.homedir === "function") ? os.homedir : (() => ""))() : "") : "");
