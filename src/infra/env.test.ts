...
describe("logAcceptedEnvOption", () => {
  it("logs accepted env options once with redaction and formatting", () => {
    ...
    withEnv(
      {
        ...
        POWERDIRECTOR_TEST_ENV: "  line one\nline two  ",
      },
      () => {
        logAcceptedEnvOption({
          key: "POWERDIRECTOR_TEST_ENV",
    ...
    expect(loggerMocks.info).toHaveBeenCalledWith(
      "env: POWERDIRECTOR_TEST_ENV=<redacted> (test option)",
    );
  });
    ...
    withEnv(
      {
        VITEST: "1",
        NODE_ENV: "development",
        POWERDIRECTOR_BLANK_ENV: "value",
      },
      () => {
        logAcceptedEnvOption({
          key: "POWERDIRECTOR_BLANK_ENV",
