...
const CORE_PACKAGE_NAMES = new Set(["powerdirector"]);
...
export async function resolvePowerDirectorPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolvePowerDirectorPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
