...
describe("channel action capability matrix", () => {
  ...
  function getCapabilities(plugin: Pick<ChannelPlugin, "actions">, cfg: PowerDirectorConfig) {
  ...
  it("forwards Telegram action capabilities through the channel wrapper", () => {
    ...
    const result = getCapabilities(telegramPlugin, {} as PowerDirectorConfig);
    ...
    const discordResult = getCapabilities(discordPlugin, {} as PowerDirectorConfig);
