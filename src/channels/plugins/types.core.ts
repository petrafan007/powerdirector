...
export type ChannelAgentToolFactory = (params: { cfg?: PowerDirectorConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: PowerDirectorConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
   ...
   */
  listActions?: (params: { cfg: PowerDirectorConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: PowerDirectorConfig }) => boolean;
  supportsCards?: (params: { cfg: PowerDirectorConfig }) => boolean;
