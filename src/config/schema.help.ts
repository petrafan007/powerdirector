...
export const FIELD_HELP: Record<string, string> = {
  ...
  "wizard.lastRunVersion":
    "PowerDirector version recorded at the time of the most recent wizard run on this config. Use this when diagnosing behavior differences across version-to-version onboarding changes.",
  ...
  "browser.profiles.*.driver":
    'Per-profile browser driver mode: "powerdirector" (or legacy "clawd") or "extension" depending on connection/runtime strategy. Use the driver that matches your browser control stack to avoid protocol mismatches.',
