...
describe("Integration: saveSessionStore with pruning", () => {
  ...
  beforeEach(async () => {
    ...
    savedCacheTtl = process.env.POWERDIRECTOR_SESSION_CACHE_TTL_MS;
  ...
  afterEach(() => {
    ...
    if (savedCacheTtl === undefined) {
      delete process.env.POWERDIRECTOR_SESSION_CACHE_TTL_MS;
    } else {
      process.env.POWERDIRECTOR_SESSION_CACHE_TTL_MS = savedCacheTtl;
    }
  });
