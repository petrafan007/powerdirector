...
function isTelegramConfigured(cfg: PowerDirectorConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: PowerDirectorConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: PowerDirectorConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: PowerDirectorConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: PowerDirectorConfig): boolean {
...
function isIMessageConfigured(cfg: PowerDirectorConfig): boolean {
...
function isWhatsAppConfigured(cfg: PowerDirectorConfig): boolean {
...
function isGenericChannelConfigured(cfg: PowerDirectorConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: PowerDirectorConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: PowerDirectorConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: PowerDirectorConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: PowerDirectorConfig, pluginId: string): boolean {
...
function registerPluginEntry(cfg: PowerDirectorConfig, pluginId: string): PowerDirectorConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
