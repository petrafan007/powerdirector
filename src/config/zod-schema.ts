    ...
    ui: z
      .object({
        ...
        assistant: z
          ...
          .strict()
          .optional(),
        // PowerDirector UI runtime settings (kept for dashboard parity/compatibility).
...
// PowerDirector keeps the local export name for existing callers/tests.
export const PowerDirectorSchema = OpenClawSchema;
