...
export class MemoryIndexManager extends MemoryManagerEmbeddingOps implements MemorySearchManager {
  ...
  protected readonly cfg: PowerDirectorConfig;
  ...
  private constructor(params: {
    ...
    const pr = params.providerResult ?? { provider: null, requestedProvider: "auto" as const };
    this.provider = pr.provider;
    this.requestedProvider = pr.requestedProvider;
    this.fallbackFrom = pr.fallbackFrom;
    this.fallbackReason = pr.fallbackReason;
    this.providerUnavailableReason = pr.providerUnavailableReason ?? (params.providerResult == null ? "Embedding provider result was not initialized" : undefined);
    this.openAi = pr.openAi;
    this.gemini = pr.gemini;
    this.voyage = pr.voyage;
