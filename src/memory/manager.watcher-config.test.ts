...
describe("memory watcher config", () => {
  ...
  function createWatcherConfig(overrides?: Partial<MemorySearchConfig>): PowerDirectorConfig {
    const defaults: NonNullable<NonNullable<PowerDirectorConfig["agents"]>["defaults"]> = {
  ...
  async function expectWatcherManager(cfg: PowerDirectorConfig) {
