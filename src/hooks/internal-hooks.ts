/**
 * Hook system for PowerDirector agent events
 *
...
const _g = globalThis as typeof globalThis & {
  __powerdirector_internal_hook_handlers__?: Map<string, InternalHookHandler[]>;
};
const handlers = (_g.__powerdirector_internal_hook_handlers__ ??= new Map<
  string,
  InternalHookHandler[]
>());
