...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.POWERDIRECTOR_SERVICE_MARKER;
  ...
  beforeEach(() => {
    ...
    delete process.env.POWERDIRECTOR_SERVICE_MARKER;
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.POWERDIRECTOR_SERVICE_MARKER = originalServiceMarker;
    }
  });
