...
// Force the plugin loader to use the sanitized extensions in src-backend
// when running within the Next.js build environment (page data collection).
env.POWERDIRECTOR_BUNDLED_PLUGINS_DIR = path.resolve(__dirname, '../src-backend/extensions');
