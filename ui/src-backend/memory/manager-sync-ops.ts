...
import { DEFAULT_MISTRAL_EMBEDDING_MODEL } from "./embeddings-mistral";
import { DEFAULT_OLLAMA_EMBEDDING_MODEL } from "./embeddings-ollama";
...
import { isFileMissingError } from "./fs-utils";
import {
  buildFileEntry,
  ensureDir,
  hashText,
...
export abstract class MemoryManagerSyncOps {
  protected abstract readonly cfg: PowerDirectorConfig;
      ...
      try {
        ...
        if (activated) {
          if (
            ...
            process.env.POWERDIRECTOR_TEST_MEMORY_UNSAFE_REINDEX === "1"
          ) {
