...
import type { DmPolicy, GroupPolicy, WhatsAppAccountConfig } from '../config/types';
...
export function listWhatsAppAuthDirs(cfg: PowerDirectorConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: PowerDirectorConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: PowerDirectorConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: PowerDirectorConfig): ResolvedWhatsAppAccount[] {
