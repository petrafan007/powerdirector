...
import { isMinimaxVlmModel, minimaxUnderstandImage } from "../../agents/minimax-vlm";
import {
  getApiKeyForModel,
  requireApiKey,
  resolveApiKeyForProvider,
} from "../../agents/model-auth";
import { normalizeModelRef } from "../../agents/model-selection";
import { ensurePowerDirectorModelsJson } from "../../agents/models-config";
import { coerceImageAssistantText } from "../../agents/tools/image-tool.helpers";
import type {
...
let piModelDiscoveryRuntimePromise: Promise<
  typeof import("../../agents/pi-model-discovery-runtime")
> | null = null;

function loadPiModelDiscoveryRuntime() {
  piModelDiscoveryRuntimePromise ??= import("../../agents/pi-model-discovery-runtime");
