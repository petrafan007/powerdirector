...
import { listThinkingLevels } from "../auto-reply/thinking";
import type { GatewayClient } from "../gateway/client";
import type { EventFrame } from "../gateway/protocol/index";
import type { GatewaySessionRow, SessionsListResult } from "../gateway/session-utils";
import {
...
function buildSessionPresentation(params: {
  ...
  const configOptions: SessionConfigOption[] = [
    buildSelectConfigOption({
      ...
      description:
        "Controls how much deliberate reasoning PowerDirector requests from the Gateway model.",
    ...
    buildSelectConfigOption({
      ...
      name: "Tool verbosity",
      description:
        "Controls how much tool progress and output detail PowerDirector keeps enabled for the session.",
    ...
    buildSelectConfigOption({
      ...
      name: "Usage detail",
      description:
        "Controls how much usage information PowerDirector attaches to responses for the session.",
...
export class AcpGatewayAgent implements Agent {
  ...
  private assertSupportedSessionSetup(mcpServers: ReadonlyArray<unknown>): void {
    ...
    throw new Error(
      "ACP bridge mode does not support per-session MCP servers. Configure MCP on the PowerDirector gateway or agent instead.",
    );
  }
