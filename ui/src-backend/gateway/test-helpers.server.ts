...
import { buildDeviceAuthPayloadV3 } from "./device-auth";
...
const GATEWAY_TEST_ENV_KEYS = [
  ...
  "POWERDIRECTOR_SKIP_BROWSER_CONTROL_SERVER",
  "POWERDIRECTOR_SKIP_GMAIL_WATCHER",
  "POWERDIRECTOR_SKIP_CANVAS_HOST",
  "POWERDIRECTOR_BUNDLED_PLUGINS_DIR",
  "POWERDIRECTOR_SKIP_CHANNELS",
  "POWERDIRECTOR_SKIP_PROVIDERS",
  "POWERDIRECTOR_SKIP_CRON",
  "POWERDIRECTOR_TEST_MINIMAL_GATEWAY",
] as const;
...
async function resetGatewayTestState(options: { uniqueConfigRoot: boolean }) {
  ...
  if (options.uniqueConfigRoot) {
    const suiteRoot = path.join(tempHome, ".powerdirector-test-suite");
...
const CONNECT_CHALLENGE_NONCE_KEY = "__powerdirectorTestConnectChallengeNonce";
const CONNECT_CHALLENGE_TRACKED_KEY = "__powerdirectorTestConnectChallengeTracked";
