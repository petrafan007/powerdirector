...
import { createHooksRequestHandler, type HookClientIpConfig } from "../server-http";

type SubsystemLogger = ReturnType<typeof createSubsystemLogger>;

export function resolveHookClientIpConfig(cfg: PowerDirectorConfig): HookClientIpConfig {
  return {
