...
import { verifyDeviceBootstrapToken } from "../../../infra/device-bootstrap";
import {
...
import { roleScopesAllow } from "../../../shared/operator-scope-compat";
...
import { isLocalDirectRequest } from "../../auth";
import {
  buildCanvasScopedHostUrl,
  CANVAS_CAPABILITY_TTL_MS,
  mintCanvasCapabilityToken,
} from "../../canvas-capability";
import { normalizeDeviceMetadataForAuth } from "../../device-auth";
import {
  isLocalishHost,
  isLoopbackAddress,
...
} from "../../protocol/connect-error-details";
import {
  type ConnectParams,
  ErrorCodes,
  type ErrorShape,
...
import { parseGatewayRole } from "../../role-policy";
import {
  MAX_BUFFERED_BYTES,
  MAX_PAYLOAD_BYTES,
...
import { resolveConnectAuthDecision, resolveConnectAuthState } from "./auth-context";
import { formatGatewayAuthFailureMessage } from "./auth-messages";
import {
...
} from "./handshake-auth-helpers";
import { isUnauthorizedRoleError, UnauthorizedFloodGuard } from "./unauthorized-flood-guard";
