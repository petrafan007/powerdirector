...
import { CONFIG_PATH, type HookMappingConfig, type HooksConfig } from "../config/config";
import { importFileModule, resolveFunctionModuleExport } from "../hooks/module-loader";
import type { HookMessageChannel } from "./hooks";
