...
import type { ConfigValidationIssue, PowerDirectorConfig } from "../../config/types.powerdirector";
import {
...
function parseValidateConfigFromRawOrRespond(
  ...
  snapshot: Awaited<ReturnType<typeof readConfigFileSnapshot>>,
  respond: RespondFn,
): { config: PowerDirectorConfig; schema: ConfigSchemaResponse } | null {
...
function loadSchemaWithPlugins(): ConfigSchemaResponse {
  ...
  // our cache. However, both loadConfig() and loadPowerDirectorPlugins() already cache
