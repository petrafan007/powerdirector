...
import { stripEnvelopeFromMessage, stripEnvelopeFromMessages } from "../chat-sanitize";
import { ADMIN_SCOPE } from "../method-scopes";
import {
  GATEWAY_CLIENT_CAPS,
  GATEWAY_CLIENT_MODES,
  GATEWAY_CLIENT_NAMES,
  hasGatewayClientCap,
} from "../protocol/client-info";
import {
  ErrorCodes,
  errorShape,
...
import { CHAT_SEND_SESSION_KEY_MAX_LENGTH } from "../protocol/schema/primitives";
...
import { setGatewayDedupeEntry } from "./agent-wait-dedupe";
import { normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize";
import { appendInjectedAssistantMessageToTranscript } from "./chat-transcript-inject";
import type {
...
function buildOversizedHistoryPlaceholder(message?: unknown): Record<string, unknown> {
  ...
  return {
    ...
    __powerdirector: { truncated: true, reason: "oversized" },
  };
}
