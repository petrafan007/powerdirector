...
import { getFreePort, onceMessage, startGatewayServer } from './test-helpers.server';
...
beforeAll(async () => {
  previousToken = process.env.POWERDIRECTOR_GATEWAY_TOKEN;
  process.env.POWERDIRECTOR_GATEWAY_TOKEN = "test-gateway-token-1234567890";
...
test.each([
  { clientId: "powerdirector-ios", platform: "ios" },
  { clientId: "powerdirector-android", platform: "android" },
