...
import type { GroupPolicy } from "../../config/types.base";
...
type ConfigGroupPolicyWarningCollector<Params extends { cfg: PowerDirectorConfig }> = (
  params: Params,
) => string[];
...
export function createAllowlistProviderRestrictSendersWarningCollector<ResolvedAccount>(
  params: {
    providerConfigPresent: (cfg: PowerDirectorConfig) => boolean;
  ...
  return createAllowlistProviderGroupPolicyWarningCollector({
    providerConfigPresent: params.providerConfigPresent,
    resolveGroupPolicy: ({ account }: { account: ResolvedAccount; cfg: PowerDirectorConfig }) =>
...
export function createAllowlistProviderGroupPolicyWarningCollector<
  Params extends { cfg: PowerDirectorConfig },
>(params: {
  providerConfigPresent: (cfg: PowerDirectorConfig) => boolean;
