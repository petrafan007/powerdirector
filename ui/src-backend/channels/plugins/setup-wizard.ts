...
import { configureChannelAccessWithAllowlist } from "./setup-group-access-configure";
import type { ChannelAccessPolicy } from "./setup-group-access";
import {
...
export type ChannelSetupWizardStatus = {
  ...
  resolveConfigured: (params: { cfg: PowerDirectorConfig }) => boolean | Promise<boolean>;
...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: PowerDirectorConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: PowerDirectorConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: PowerDirectorConfig; accountId: string }) => boolean;
  inspect: (params: {
    cfg: PowerDirectorConfig;
    accountId: string;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: PowerDirectorConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: PowerDirectorConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: PowerDirectorConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: PowerDirectorConfig;
    accountId: string;
...
export type ChannelSetupWizard = {
  ...
  disable?: (cfg: PowerDirectorConfig) => PowerDirectorConfig;
