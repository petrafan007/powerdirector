...
export function supportsChannelMessageButtons(cfg: PowerDirectorConfig): boolean {
...
export function supportsChannelMessageCards(cfg: PowerDirectorConfig): boolean {
