...
import { normalizeAnyChannelId } from "../registry";
import { getChannelPlugin, listChannelPlugins } from "./index";
import type { ChannelMessageCapability } from "./message-capabilities";
import type {
...
export function createMessageActionDiscoveryContext(
  ...
  return {
    cfg: params.cfg ?? ({} as PowerDirectorConfig),
...
export function listChannelMessageActions(cfg: PowerDirectorConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: PowerDirectorConfig): ChannelMessageCapability[] {
