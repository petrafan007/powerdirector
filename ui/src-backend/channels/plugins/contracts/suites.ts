...
import { createNonExitingRuntime } from "../../../runtime";
import { normalizeChatType } from "../../chat-type";
import { resolveConversationLabel } from "../../conversation-label";
...
type ChannelSetupContractCase<ResolvedAccount> = {
  ...
  beforeTest?: () => void;
  assertPatchedConfig?: (cfg: PowerDirectorConfig) => void;
  assertResolvedAccount?: (account: ResolvedAccount, cfg: PowerDirectorConfig) => void;
};
