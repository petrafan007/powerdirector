...
import { createDelegatedSetupWizardStatusResolvers } from "./setup-wizard-binary";
import type { ChannelSetupDmPolicy } from "./setup-wizard-types";
import type { ChannelSetupWizard } from "./setup-wizard";
...
export function createAllowlistSetupWizardProxy<TGroupResolved>(params: {
  loadWizard: () => Promise<ChannelSetupWizard>;
  createBase: (handlers: {
    promptAllowFrom: (params: PromptAllowFromParams) => Promise<PowerDirectorConfig>;
