import { resolveOutboundSendDep } from "../../infra/outbound/send-deps";
import { createAttachedChannelResultAdapter } from "../../plugin-sdk/channel-send-result";
import type { PluginRuntimeChannel } from "../../plugins/runtime/types-channel";
