import { listConfiguredBindings } from "../../config/bindings";
import type { PowerDirectorConfig } from "../../config/config";
import { getActivePluginRegistry, getActivePluginRegistryVersion } from "../../plugins/runtime";
import { pickFirstExistingAgentId } from "../../routing/resolve-route";
import { resolveChannelConfiguredBindingProvider } from "./binding-provider";
import type { CompiledConfiguredBinding, ConfiguredBindingChannel } from "./binding-types";
import { resolveConfiguredBindingConsumer } from "./configured-binding-consumers";
import { getChannelPlugin } from "./index";
import type {
