...
import type { ReplyToMode } from "../../config/types.base";
import type { ChannelThreadingAdapter } from "./types.core";
...
export function createScopedAccountReplyToModeResolver<TAccount>(params: {
  resolveAccount: (cfg: PowerDirectorConfig, accountId?: string | null) => TAccount;
  resolveReplyToMode: (
    account: TAccount,
