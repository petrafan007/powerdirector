...
function setDiscordDmPolicy(cfg: PowerDirectorConfig, dmPolicy: DmPolicy) {
...
function setDiscordAllowFrom(cfg: PowerDirectorConfig, allowFrom: string[]): PowerDirectorConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
