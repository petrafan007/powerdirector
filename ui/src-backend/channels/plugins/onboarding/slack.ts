...
function setSlackDmPolicy(cfg: PowerDirectorConfig, dmPolicy: DmPolicy) {
...
function buildSlackManifest(botName: string) {
  const safeName = botName.trim() || "PowerDirector";
  const manifest = {
    display_information: {
      name: safeName,
      description: `${safeName} connector for PowerDirector`,
    },
    features: {
      bot_user: {
      ...
      slash_commands: [
        {
          ...
          description: "Send a message to PowerDirector",
          should_escape: false,
        },
      ],
    },
...
function setSlackAllowFrom(cfg: PowerDirectorConfig, allowFrom: string[]): PowerDirectorConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
