...
} from "../../acp/persistent-bindings.types";
import {
  resolveAgentConfig,
...
import type { ConfiguredBindingConsumer } from "./configured-binding-consumers";
import type { ChannelConfiguredBindingConversationRef } from "./types.adapters";

function resolveAgentRuntimeAcpDefaults(params: { cfg: PowerDirectorConfig; ownerAgentId: string }): {
  acpAgentId?: string;
  mode?: string;
  cwd?: string;
  backend?: string;
