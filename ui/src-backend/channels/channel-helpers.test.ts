...
import { buildMessagingTarget, ensureTargetId, requireTargetKind } from './targets';
import { createTypingCallbacks } from './typing';
...
describe("channel registry helpers", () => {
  ...
  it("formats selection lines with docs labels + website extras", () => {
    ...
    expect(line).toContain("https://powerdirector.ai");
  });
});
