import { CHANNEL_IDS, CHAT_CHANNEL_ORDER, type ChatChannelId } from "./ids";
import type { ChannelMeta } from "./plugins/types";
import type { ChannelId } from "./plugins/types";
export { CHANNEL_IDS, CHAT_CHANNEL_ORDER } from "./ids";
export type { ChatChannelId } from "./ids";

export type ChatChannelMeta = ChannelMeta;

const WEBSITE_URL = "https://powerdirector.ai";
