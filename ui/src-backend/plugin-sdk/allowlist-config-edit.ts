import type { ConfigWriteTarget } from "../channels/plugins/config-writes";
import type { ChannelAllowlistAdapter } from "../channels/plugins/types.adapters";
import type { ChannelId } from "../channels/plugins/types";
import type { PowerDirectorConfig } from "../config/config";
import { isBlockedObjectKey } from "../infra/prototype-keys";
...
export function createAccountScopedAllowlistNameResolver<ResolvedAccount>(params: {
  resolveAccount: (params: { cfg: PowerDirectorConfig; accountId?: string | null }) => ResolvedAccount;
