...
} from "../auto-reply/reply/dispatch-from-config";
import type { ReplyDispatcher } from "../auto-reply/reply/reply-dispatcher";
import type { FinalizedMsgContext } from "../auto-reply/templating";
import type { GetReplyOptions } from "../auto-reply/types";
import type { PowerDirectorConfig } from "../config/config";
import { createChannelReplyPipeline } from "./channel-reply-pipeline";
import { createNormalizedOutboundDeliverer, type OutboundReplyPayload } from "./reply-payload";

type ReplyOptionsWithoutModelSelected = Omit<
  Omit<GetReplyOptions, "onToolResult" | "onBlockReply">,
  "onModelSelected"
>;
type RecordInboundSessionFn = typeof import("../channels/session").recordInboundSession;
