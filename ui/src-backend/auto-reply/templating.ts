...
import type { StickerMetadata } from '../telegram/bot/types';
import type { InternalMessageChannel } from '../utils/message-channel';
import type { CommandArgs } from './commands-registry.types';
...
export type MsgContext = {
  ...
  OutputDir?: string;
  OutputBase?: string;
  /** Remote host for SCP when media lives on a different machine (e.g., powerdirector@192.168.64.3). */
