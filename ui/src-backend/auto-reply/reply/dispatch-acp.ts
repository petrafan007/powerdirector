...
import type { AcpTurnAttachment } from "../../acp/control-plane/manager.types";
import { resolveAcpAgentPolicyError, resolveAcpDispatchPolicyError } from "../../acp/policy";
import { formatAcpRuntimeErrorText } from "../../acp/runtime/error-text";
import { toAcpRuntimeError } from "../../acp/runtime/errors";
import { resolveAcpThreadSessionDetailLines } from "../../acp/runtime/session-identifiers";
import {
  isSessionIdentityPending,
  resolveSessionIdentityFromMeta,
} from "../../acp/runtime/session-identity";
...
import { getSessionBindingService } from "../../infra/outbound/session-binding-service";
import { generateSecureUuid } from "../../infra/secure-random";
import { prefixSystemMessage } from "../../infra/system-message";
import { applyMediaUnderstanding } from "../../media-understanding/apply";
import {
  normalizeAttachmentPath,
  normalizeAttachments,
} from "../../media-understanding/attachments.normalize";
import { resolveAgentIdFromSessionKey } from "../../routing/session-key";
import { maybeApplyTtsToPayload, resolveTtsConfig } from "../../tts/tts";
import {
  isCommandEnabled,
...
import { createAcpReplyProjector } from "./acp-projector";
import { createAcpDispatchDeliveryCoordinator } from "./dispatch-acp-delivery";
