...
import { copyFileWithinRoot, SafeOpenError } from "../../infra/fs-safe";
import { normalizeScpRemoteHost, normalizeScpRemotePath } from "../../infra/scp-host";
import { resolvePreferredPowerDirectorTmpDir } from "../../infra/tmp-powerdirector-dir";
import {
  isInboundPathAllowed,
  resolveIMessageRemoteAttachmentRoots,
} from "../../media/inbound-path-policy";
import { getMediaDir, MEDIA_MAX_BYTES } from "../../media/store";
...
export async function stageSandboxMedia(params: {
  ...
  // For remote attachments without sandbox, use ~/.powerdirector/media (not agent workspace for privacy)
