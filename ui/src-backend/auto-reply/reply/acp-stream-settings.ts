import type { AcpSessionUpdateTag } from "../../acp/runtime/types";
import type { PowerDirectorConfig } from "../../config/config";
import { clampPositiveInteger, resolveEffectiveBlockStreamingConfig } from "./block-streaming";
...
function resolveAcpStreamCoalesceIdleMs(cfg: PowerDirectorConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: PowerDirectorConfig): number {
...
export function resolveAcpProjectionSettings(cfg: PowerDirectorConfig): AcpProjectionSettings {
