...
import { resetConfiguredBindingTargetInPlace } from "../../channels/plugins/binding-targets";
...
import { isAcpSessionKey, resolveAgentIdFromSessionKey } from "../../routing/session-key";
import { resolveSendPolicy } from "../../sessions/send-policy";
import { shouldHandleTextCommands } from "../commands-registry";
import { handleAcpCommand } from "./commands-acp";
import { resolveBoundAcpThreadSessionKey } from "./commands-acp/targets";
...
import { handlePluginsCommand } from "./commands-plugins";
import {
  handleAbortTrigger,
