import { resolveStoredSubagentCapabilities } from "../../../agents/subagent-capabilities";
import type { ResolvedSubagentController } from "../../../agents/subagent-control";
import {
...
import { parseExplicitTargetForChannel } from "../../../channels/plugins/target-parsing";
import type {
  SessionEntry,
...
import { looksLikeSessionId } from "../../../sessions/session-id";
