...
import { compileConfigRegexes, type ConfigRegexRejectReason } from "../../security/config-regex";
...
function resolveMentionPatterns(cfg: PowerDirectorConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: PowerDirectorConfig | undefined, agentId?: string): RegExp[] {
