...
import { resolveOriginMessageProvider } from "./origin-routing";
import { resolveQueueSettings } from "./queue";
import { routeReply } from "./route-reply";
import { buildBareSessionResetPrompt } from "./session-reset-prompt";
import { drainFormattedSystemEvents, ensureSkillSnapshot } from "./session-updates";
...
type RunPreparedReplyParams = {
  ...
  sessionCfg: PowerDirectorConfig["session"];
