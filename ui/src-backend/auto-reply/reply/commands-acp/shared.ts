...
import { toAcpRuntimeErrorText } from "../../../acp/runtime/error-text";
import type { AcpRuntimeError } from "../../../acp/runtime/errors";
import type { AcpRuntimeSessionMode } from "../../../acp/runtime/types";
import { DISCORD_THREAD_BINDING_CHANNEL } from "../../../channels/thread-bindings-policy";
import type { AcpSessionRuntimeOptions } from "../../../config/sessions/types";
import { normalizeAgentId } from "../../../routing/session-key";
import type { CommandHandlerResult, HandleCommandsParams } from "../commands-types";
import { resolveAcpCommandChannel, resolveAcpCommandThreadId } from "./context";
export { resolveAcpInstallCommandHint, resolveConfiguredAcpBackendId } from "./install-hints";
...
export { SESSION_ID_RE } from "../../../sessions/session-id";
...
export function resolveAcpHelpText(): string {
  return [
    ...
    "",
    "Notes:",
    "- /acp spawn harness-id is an ACP runtime harness alias (for example codex), not an PowerDirector agents.list id.",
