...
import type { ChatCommandDefinition } from './commands-registry.types';
...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@powerdirector", { botUsername: "powerdirector" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@powerdirector args", {
        botUsername: "powerdirector",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@powerdirector: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "powerdirector" })).toBe(
      "/help@otherbot",
    );
  });
