      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["powerdirector gateway run", "Run the gateway in the foreground."],
            ["powerdirector gateway status", "Show service status and probe reachability."],
            ["powerdirector gateway discover", "Find local and wide-area gateway beacons."],
            ["powerdirector gateway call health", "Call a gateway RPC method directly."],
