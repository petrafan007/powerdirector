...
describe("update-cli", () => {
  ...
  it("updateCommand continues after doctor sub-step and clears update flag", async () => {
    const envSnapshot = captureEnv(["POWERDIRECTOR_UPDATE_IN_PROGRESS"]);
  ...
  it("updateWizardCommand offers dev checkout and forwards selections", async () => {
    ...
    const envSnapshot = captureEnv(["POWERDIRECTOR_GIT_DIR"]);
    try {
      setTty(true);
      process.env.POWERDIRECTOR_GIT_DIR = tempDir;
