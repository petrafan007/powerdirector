    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["powerdirector directory self --channel slack", "Show the connected account identity."],
          [
            'powerdirector directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["powerdirector directory groups list --channel discord", "List available groups/channels."],
          [
            "powerdirector directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.powerdirector.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
