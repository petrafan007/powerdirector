...
import { validateSecretsResolveResult } from "../gateway/protocol/index";
import {
  analyzeCommandSecretAssignmentsFromSnapshot,
  type UnresolvedCommandSecretAssignment,
} from "../secrets/command-config";
import { getPath, setPathExistingStrict } from "../secrets/path-utils";
import { resolveSecretRefValue } from "../secrets/resolve";
import { collectConfigAssignments } from "../secrets/runtime-config-collectors";
import { createResolverContext } from "../secrets/runtime-shared";
import { resolveRuntimeWebTools } from "../secrets/runtime-web-tools";
import { assertExpectedResolvedSecretValue } from "../secrets/secret-value";
...
type ResolveCommandSecretsResult = {
  resolvedConfig: PowerDirectorConfig;
  diagnostics: string[];
