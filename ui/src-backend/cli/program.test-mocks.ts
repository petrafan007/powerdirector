...
vi.mock("../commands/message", () => ({ messageCommand: programMocks.messageCommand }));
vi.mock("../commands/status", () => ({ statusCommand: programMocks.statusCommand }));
vi.mock("../commands/configure", () => ({
