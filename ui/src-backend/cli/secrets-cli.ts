...
import { runSecretsApply } from "../secrets/apply";
import { resolveSecretsAuditExitCode, runSecretsAudit } from "../secrets/audit";
import { runSecretsConfigureInteractive } from "../secrets/configure";
import { isSecretsApplyPlan, type SecretsApplyPlan } from "../secrets/plan";
import { formatDocsLink } from "../terminal/links";
import { theme } from "../terminal/theme";
import { addGatewayClientOptions, callGatewayFromCli, type GatewayRpcOpts } from "./gateway-rpc";
...
export function registerSecretsCli(program: Command) {
  const secrets = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/gateway/security", "docs.powerdirector.ai/gateway/security")}\n`,
    );
