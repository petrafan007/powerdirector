...
import { maxBytesForKind, type MediaKind } from "./constants";
...
import { getDefaultMediaLocalRoots } from "./local-roots";
import { detectMime, extensionForMime, kindFromMime } from "./mime";
...
async function assertLocalMediaAllowed(
  ...
  // Hardening: the default allowlist includes the PowerDirector temp dir, and tests/CI may
