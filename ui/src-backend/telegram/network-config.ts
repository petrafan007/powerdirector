...
import type { TelegramNetworkConfig } from "../config/types.telegram";
import { isTruthyEnvValue } from "../infra/env";
import { isWSL2Sync } from "../infra/wsl";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "POWERDIRECTOR_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "POWERDIRECTOR_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "POWERDIRECTOR_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable POWERDIRECTOR_TELEGRAM_DNS_RESULT_ORDER
