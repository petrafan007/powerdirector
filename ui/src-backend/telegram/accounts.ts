...
} from "../plugin-sdk/account-resolution";
...
import { formatSetExplicitDefaultInstruction } from "../routing/default-account-warnings";
import {
  DEFAULT_ACCOUNT_ID,
  normalizeAccountId,
...
export function listTelegramAccountIds(cfg: PowerDirectorConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: PowerDirectorConfig): string {
...
export function mergeTelegramAccountConfig(
  ...
  // See: https://github.com/powerdirector/powerdirector/issues/30673
...
export function listEnabledTelegramAccounts(cfg: PowerDirectorConfig): ResolvedTelegramAccount[] {
