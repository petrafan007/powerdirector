...
import { AUTO_IMAGE_KEY_PROVIDERS, DEFAULT_IMAGE_MODELS } from "../media-understanding/defaults";
import { resolveAutoImageModel } from "../media-understanding/runner";
...
let imageRuntimePromise: Promise<
  typeof import("../media-understanding/providers/image-runtime")
> | null = null;

function loadImageRuntime() {
  imageRuntimePromise ??= import("../media-understanding/providers/image-runtime");
