...
import { hasProxyEnvConfigured } from "../infra/net/proxy-env";
...
function applyTelegramNetworkWorkarounds(network?: TelegramNetworkConfig): void {
  ...
  // See: https://github.com/powerdirector/powerdirector/issues/25676
  if (
  ...
  // See: https://github.com/powerdirector/powerdirector/issues/5311
