 ...
 */
export function decoratePowerDirectorProfile(
  userDataDir: string,
  opts?: { name?: string; color?: string },
) {
  const desiredName = opts?.name ?? DEFAULT_POWERDIRECTOR_BROWSER_PROFILE_NAME;
  const desiredColor = (opts?.color ?? DEFAULT_POWERDIRECTOR_BROWSER_COLOR).toUpperCase();
