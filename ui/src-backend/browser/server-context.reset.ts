...
import { BrowserResetUnsupportedError } from "./errors";
import { getBrowserProfileCapabilities } from "./profile-capabilities";
import type { ProfileRuntimeState } from "./server-context.types";
...
type ResetDeps = {
  ...
  resolvePowerDirectorUserDataDir: (profileName: string) => string;
};
