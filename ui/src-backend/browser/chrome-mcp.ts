...
import type { ChromeMcpSnapshotNode } from "./chrome-mcp.snapshot";
import type { BrowserTab } from "./client";
import { BrowserProfileUnavailableError, BrowserTabNotFoundError } from "./errors";
