...
export const CANVAS_HOST_PATH = "/__powerdirector__/canvas";

export const CANVAS_WS_PATH = "/__powerdirector__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.powerdirectorCanvasA2UIAction.postMessage(...)
  // - Android: window.powerdirectorCanvasA2UIAction.postMessage(...)
  const handlerNames = ["powerdirectorCanvasA2UIAction"];
  ...
  globalThis.PowerDirector = globalThis.PowerDirector ?? {};
  globalThis.PowerDirector.postMessage = postToNode;
  globalThis.PowerDirector.sendUserAction = sendUserAction;
  globalThis.powerdirectorPostMessage = postToNode;
  globalThis.powerdirectorSendUserAction = sendUserAction;
