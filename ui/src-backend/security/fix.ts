...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof PowerDirectorConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: PowerDirectorConfig; env: NodeJS.ProcessEnv }): {
  cfg: PowerDirectorConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
