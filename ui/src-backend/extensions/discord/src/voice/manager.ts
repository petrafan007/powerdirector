...
import { agentCommandFromIngress } from "@/src-backend/plugin-sdk/agent-runtime";
import { resolveTtsConfig, type ResolvedTtsConfig } from "@/src-backend/plugin-sdk/agent-runtime";
...
import type { DiscordAccountConfig, TtsConfig } from "@/src-backend/plugin-sdk/config-runtime";
...
import { transcribeAudioFile } from "@/src-backend/plugin-sdk/media-understanding-runtime";
...
import { parseTtsDirectives } from "@/src-backend/plugin-sdk/speech";
import { textToSpeech } from "@/src-backend/plugin-sdk/speech-runtime";
