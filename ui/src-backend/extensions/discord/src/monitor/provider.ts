...
type DiscordVoiceManager = import("../voice/manager").DiscordVoiceManager;

type DiscordVoiceRuntimeModule = typeof import("../voice/manager.runtime");
...
async function loadDiscordVoiceRuntime(): Promise<DiscordVoiceRuntimeModule> {
  discordVoiceRuntimePromise ??= import("../voice/manager.runtime");
