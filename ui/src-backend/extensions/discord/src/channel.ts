...
import { auditDiscordChannelPermissions, collectDiscordAuditChannelIds } from "./audit";
import {
...
import { monitorDiscordProvider } from "./monitor";
import {
  looksLikeDiscordTargetId,
  normalizeDiscordMessagingTarget,
  normalizeDiscordOutboundTarget,
} from "./normalize";
import { probeDiscord, type DiscordProbe } from "./probe";
...
import { createDiscordPluginBase, discordConfigAdapter } from "./shared";
import { collectDiscordStatusIssues } from "./status-issues";
...
function hasDiscordExecApprovalDmRoute(cfg: PowerDirectorConfig): boolean {
...
export const discordPlugin: ChannelPlugin<ResolvedDiscordAccount> = {
  ...
  agentPrompt: {
    messageToolHints: () => [
      ...
      "- Forms: add `components.modal` (title, fields). PowerDirector adds a trigger button and routes submissions as new messages.",
    ],
  },
  messaging: {
