...
import { listEnabledGoogleChatAccounts, resolveGoogleChatAccount } from "./accounts";
import {
...
import { resolveGoogleChatOutboundSpace } from "./targets";

const providerId = "googlechat";

function listEnabledAccounts(cfg: PowerDirectorConfig) {
  return listEnabledGoogleChatAccounts(cfg).filter(
    (account) => account.enabled && account.credentialSource !== "none",
  );
}

function isReactionsEnabled(accounts: ReturnType<typeof listEnabledAccounts>, cfg: PowerDirectorConfig) {
