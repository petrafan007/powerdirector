...
import { getPublicKeyFromPrivate } from "./nostr-bus";
...
function resolveConfiguredDefaultNostrAccountId(cfg: PowerDirectorConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: PowerDirectorConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: PowerDirectorConfig): string {
