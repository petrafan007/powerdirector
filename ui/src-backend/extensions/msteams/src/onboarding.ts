...
import { hasConfiguredMSTeamsCredentials, resolveMSTeamsCredentials } from "./token";

const channel = "msteams" as const;

function setMSTeamsDmPolicy(cfg: PowerDirectorConfig, dmPolicy: DmPolicy) {
...
function setMSTeamsAllowFrom(cfg: PowerDirectorConfig, allowFrom: string[]): PowerDirectorConfig {
