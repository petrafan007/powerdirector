/**
 * Synology Chat Channel Plugin for PowerDirector.
 *
...
import { sendMessage, sendFileUrl } from "./client";
import { getSynologyRuntime } from "./runtime";
import { synologyChatSetupAdapter, synologyChatSetupWizard } from "./setup-surface";
import type { ResolvedSynologyChatAccount } from "./types";
...
const resolveSynologyChatDmPolicy = createScopedDmSecurityResolver<ResolvedSynologyChatAccount>({
  ...
  approveHint: "powerdirector pairing approve synology-chat <code>",
...
export function createSynologyChatPlugin() {
  return {
    ...
    meta: {
      ...
      blurb: "Connect your Synology NAS Chat to PowerDirector",
      order: 90,
    },
    ...
    pairing: createTextPairingAdapter({
      ...
      message: "PowerDirector: your access has been approved.",
