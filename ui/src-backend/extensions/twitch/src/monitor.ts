...
import type { ReplyPayload, PowerDirectorConfig } from "../api";
import { createChannelReplyPipeline } from "../api";
import { checkTwitchAccessControl } from "./access-control";
import { getOrCreateClientManager } from "./client-manager-registry";
import { getTwitchRuntime } from "./runtime";
import type { TwitchAccountConfig, TwitchChatMessage } from "./types";
import { stripMarkdownForTwitch } from "./utils/markdown";
...
export type TwitchMonitorOptions = {
  ...
  accountId: string;
  config: unknown; // PowerDirectorConfig
