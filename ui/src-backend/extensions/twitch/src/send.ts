...
import { getClientManager as getRegistryClientManager } from "./client-manager-registry";
...
import { generateMessageId, isAccountConfigured, normalizeTwitchChannel } from "./utils/twitch";
 ...
 *
 * This function has access to the full PowerDirector config and handles
 * account resolution, markdown stripping, and actual message sending.
 *
 * @param channel - The channel name
 * @param text - The message text
 * @param cfg - Full PowerDirector configuration
