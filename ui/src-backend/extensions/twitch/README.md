...
```bash
powerdirector plugins install ./extensions/twitch
```

## Install (npm)

```bash
powerdirector plugins install @powerdirector/twitch
```
...
See https://docs.powerdirector.ai/channels/twitch for:
