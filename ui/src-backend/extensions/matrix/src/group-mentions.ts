import type { ChannelGroupContext, GroupToolPolicyConfig } from "../runtime-api";
import { resolveMatrixAccountConfig } from "./matrix/accounts";
import { resolveMatrixRoomConfig } from "./matrix/monitor/rooms";
