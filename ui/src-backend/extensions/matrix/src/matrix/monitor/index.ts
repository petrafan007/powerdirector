...
import { resolveMatrixTargets } from "../../resolve-targets";
import { getMatrixRuntime } from "../../runtime";
import type { CoreConfig, MatrixConfig, MatrixRoomConfig, ReplyToMode } from "../../types";
import { resolveMatrixAccount } from "../accounts";
import { setActiveMatrixClient } from "../active-client";
import {
  isBunRuntime,
  resolveMatrixAuth,
...
import { normalizeMatrixUserId } from "./allowlist";
import { registerMatrixAutoJoin } from "./auto-join";
import { createDirectRoomTracker } from "./direct";
import { registerMatrixMonitorEvents } from "./events";
import { createMatrixRoomMessageHandler } from "./handler";
import { createMatrixRoomInfoResolver } from "./room-info";
