...
import { createPreparedMatrixClient } from "../client-bootstrap";
import { isBunRuntime, resolveMatrixAuth, resolveSharedMatrixClient } from "../client";
import type { MatrixActionClient, MatrixActionClientOpts } from "./types";
...
export async function resolveActionClient(
  ...
  const shouldShareClient = Boolean(process.env.POWERDIRECTOR_GATEWAY_PORT);
