...
import { matrixMessageActions } from "./actions";
import { MatrixConfigSchema } from "./config-schema";
import {
...
import { normalizeMatrixAllowList, normalizeMatrixUserId } from "./matrix/monitor/allowlist";
import { getMatrixRuntime } from "./runtime";
import { resolveMatrixOutboundSessionRoute } from "./session-route";
import { matrixSetupAdapter } from "./setup-core";
import { matrixSetupWizard } from "./setup-surface";
...
export const matrixPlugin: ChannelPlugin<ResolvedMatrixAccount> = {
  ...
  gateway: {
    startAccount: async (ctx) => {
      ...
      let monitorMatrixProvider: typeof import("./matrix/index").monitorMatrixProvider;
      try {
        const module = await import("./matrix/index");
