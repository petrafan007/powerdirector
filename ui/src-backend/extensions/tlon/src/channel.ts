...
import { resolveTlonAccount, listTlonAccountIds } from "./types";
...
const tlonConfigAdapter = createHybridChannelConfigAdapter({
  ...
  listAccountIds: (cfg: PowerDirectorConfig) => listTlonAccountIds(cfg),
  resolveAccount: (cfg: PowerDirectorConfig, accountId?: string | null) =>
