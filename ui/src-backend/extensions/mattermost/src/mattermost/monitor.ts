...
import { getMattermostRuntime } from "../runtime";
import { resolveMattermostAccount, resolveMattermostReplyToMode } from "./accounts";
import {
...
import { resolveOncharPrefixes, stripOncharPrefix } from "./monitor-onchar";
import { createMattermostMonitorResources, type MattermostMediaInfo } from "./monitor-resources";
import { registerMattermostMonitorSlashCommands } from "./monitor-slash";
import {
  createMattermostConnectOnce,
  type MattermostEventPayload,
  type MattermostWebSocketFactory,
} from "./monitor-websocket";
import { runWithReconnect } from "./reconnect";
import { deliverMattermostReplyPayload } from "./reply-delivery";
import { sendMessageMattermost } from "./send";
import { cleanupSlashCommands } from "./slash-commands";
import { deactivateSlashCommands, getSlashCommandState } from "./slash-state";
      ...
      authorizeButtonClick: async ({ payload, post }) => {
        ...
        return {
          ...
          response: {
            ...
            ephemeral_text: `PowerDirector ignored this action for ${decision.roomLabel}.`,
          },
        };
      },
