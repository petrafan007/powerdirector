...
This directory contains the **BlueBubbles external channel plugin** for PowerDirector.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `powerdirector/plugin-sdk` helpers.
