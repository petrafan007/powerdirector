...
import { sendBlueBubblesAttachment } from "./attachments";
import { resolveBlueBubblesMessageId } from "./monitor";
import { resolveChannelMediaMaxBytes, type PowerDirectorConfig } from "./runtime-api";
...
function resolveMediaLocalRoots(params: { cfg: PowerDirectorConfig; accountId?: string }): string[] {
