...
import { normalizeIrcAllowlist, resolveIrcAllowlistMatch } from "./normalize";
import {
...
import { getIrcRuntime } from "./runtime";
import { sendMessageIrc } from "./send";
import type { CoreConfig, IrcInboundMessage } from "./types";
