...
import { IrcConfigSchema } from "./config-schema";
import { monitorIrcProvider } from "./monitor";
import {
...
import { resolveIrcGroupMatch, resolveIrcRequireMention } from "./policy";
import { probeIrc } from "./probe";
import {
...
import { ircSetupAdapter } from "./setup-core";
import { ircSetupWizard } from "./setup-surface";
import type { CoreConfig, IrcProbe } from "./types";
