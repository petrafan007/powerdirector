...
} from "./bot-native-commands.fixture-test-support";
...
const skillCommandMocks = vi.hoisted(() => ({
  listSkillCommandsForAgents: vi.fn<
    (params: { cfg: PowerDirectorConfig; agentIds?: string[] }) => SkillCommandSpec[]
  >(() => []),
}));
...
export function createNativeCommandTestParams(
  ...
  const telegramDeps: TelegramBotDeps = {
    loadConfig: vi.fn(() => ({}) as PowerDirectorConfig) as TelegramBotDeps["loadConfig"],
