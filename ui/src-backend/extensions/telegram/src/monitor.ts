...
import { resolveTelegramTransport } from "./fetch";
import {
  isRecoverableTelegramNetworkError,
  isTelegramPollingNetworkError,
} from "./network-errors";
import { TelegramPollingSession } from "./polling-session";
...
export function createTelegramRunnerOptions(cfg: PowerDirectorConfig): RunOptions<unknown> {
  return {
    sink: {
