...
import type { AnyAgentTool, PowerDirectorPluginApi, PowerDirectorPluginToolContext } from "../api";
import { PlaywrightDiffScreenshotter, type DiffScreenshotter } from "./browser";
import { resolveDiffImageRenderOptions } from "./config";
import { renderDiffDocument } from "./render";
import type { DiffArtifactStore } from "./store";
import type { DiffArtifactContext, DiffRenderOptions, DiffToolDefaults } from "./types";
import {
...
import { buildViewerUrl, normalizeViewerBaseUrl } from "./url";
...
function buildArtifactContext(
  context: PowerDirectorPluginToolContext | undefined,
