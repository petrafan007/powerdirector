...
import { sendMessageZalo } from "./send";

export async function notifyZaloPairingApproval(params: { cfg: PowerDirectorConfig; id: string }) {
...
export async function probeZaloAccount(params: {
  account: import("./accounts").ResolvedZaloAccount;
  timeoutMs?: number;
}) {
