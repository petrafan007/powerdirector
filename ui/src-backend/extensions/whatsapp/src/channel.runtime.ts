import { getActiveWebListener as getActiveWebListenerImpl } from "./active-listener";
import {
...
import { monitorWebChannel as monitorWebChannelImpl } from "./auto-reply/monitor";
import { loginWeb as loginWebImpl } from "./login";
import { whatsappSetupWizard as whatsappSetupWizardImpl } from "./setup-surface";

type GetActiveWebListener = typeof import("./active-listener").getActiveWebListener;
type GetWebAuthAgeMs = typeof import("./auth-store").getWebAuthAgeMs;
type LogWebSelfId = typeof import("./auth-store").logWebSelfId;
type LogoutWeb = typeof import("./auth-store").logoutWeb;
type ReadWebSelfId = typeof import("./auth-store").readWebSelfId;
type WebAuthExists = typeof import("./auth-store").webAuthExists;
type LoginWeb = typeof import("./login").loginWeb;
type StartWebLoginWithQr = typeof import("./login-qr").startWebLoginWithQr;
type WaitForWebLogin = typeof import("./login-qr").waitForWebLogin;
type WhatsAppSetupWizard = typeof import("./setup-surface").whatsappSetupWizard;
type MonitorWebChannel = typeof import("./auto-reply/monitor").monitorWebChannel;

let loginQrPromise: Promise<typeof import("./login-qr")> | null = null;

function loadWhatsAppLoginQr() {
  loginQrPromise ??= import("./login-qr");
