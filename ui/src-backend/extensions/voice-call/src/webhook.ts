...
import { normalizeVoiceCallConfig, type VoiceCallConfig } from "./config";
import type { CoreAgentDeps, CoreConfig } from "./core-bridge";
import type { CallManager } from "./manager";
import type { MediaStreamConfig } from "./media-stream";
import { MediaStreamHandler } from "./media-stream";
import type { VoiceCallProvider } from "./providers/base";
import { OpenAIRealtimeSTTProvider } from "./providers/stt-openai-realtime";
import type { TwilioProvider } from "./providers/twilio";
import type { NormalizedEvent, WebhookContext } from "./types";
import { startStaleCallReaper } from "./webhook/stale-call-reaper";
...
<Response>
  ...
  private async handleInboundResponse(callId: string, userMessage: string): Promise<void> {
    ...
    try {
      const { generateVoiceResponse } = await import("./response-generator");
