...
import { lineConfigAdapter } from "./config-adapter";
import { resolveLineGroupRequireMention } from "./group-policy";
import { getLineRuntime } from "./runtime";
import { lineSetupAdapter } from "./setup-core";
import { lineSetupWizard } from "./setup-surface";
...
const resolveLineDmPolicy = createScopedDmSecurityResolver<ResolvedLineAccount>({
  ...
  approveHint: "powerdirector pairing approve line <code>",
