...
import { buildFeishuConversationId, parseFeishuConversationId } from "./conversation-id";
import { normalizeFeishuTarget } from "./targets";
import { getFeishuThreadBindingManager } from "./thread-bindings";
...
export function registerFeishuSubagentHooks(api: PowerDirectorPluginApi) {
