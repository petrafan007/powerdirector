...
import { FeishuDriveSchema, type FeishuDriveParams } from "./drive-schema";
import { createFeishuToolClient, resolveAnyEnabledFeishuToolsConfig } from "./tool-account";
import {
  jsonToolResult,
...
export function registerFeishuDriveTools(api: PowerDirectorPluginApi) {
  if (!api.config) {
