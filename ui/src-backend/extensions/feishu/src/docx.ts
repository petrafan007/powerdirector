...
import { listEnabledFeishuAccounts } from "./accounts";
import { FeishuDocSchema, type FeishuDocParams } from "./doc-schema";
import { BATCH_SIZE, insertBlocksInBatches } from "./docx-batch-insert";
import { updateColorText } from "./docx-color-text";
import {
...
export function registerFeishuDocTools(api: PowerDirectorPluginApi) {
  if (!api.config) {
