...
import { resolveToolsConfig } from "./tools-config";
import type { FeishuToolsConfig, ResolvedFeishuAccount } from "./types";
...
function readConfiguredDefaultAccountId(config: PowerDirectorPluginApi["config"]): string | undefined {
...
export function resolveFeishuToolAccount(params: {
  api: Pick<PowerDirectorPluginApi, "config">;
