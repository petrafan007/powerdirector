...
function setFeishuGroupAllowFrom(cfg: PowerDirectorConfig, groupAllowFrom: string[]): PowerDirectorConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
...
function isFeishuConfigured(cfg: PowerDirectorConfig): boolean {
...
export { feishuSetupAdapter } from "./setup-core";
