...
import { buildZalouserGroupCandidates, findZalouserGroupEntry } from "./group-policy";
import { resolveZalouserReactionMessageIds } from "./message-sid";
import { probeZalouser } from "./probe";
import { writeQrDataUrlToTempFile } from "./qr-temp-file";
import { getZalouserRuntime } from "./runtime";
import { sendMessageZalouser, sendReactionZalouser } from "./send";
import { resolveZalouserOutboundSessionRoute } from "./session-route";
...
import { collectZalouserStatusIssues } from "./status-issues";
import {
...
function resolveZalouserOutboundChunkMode(cfg: PowerDirectorConfig, accountId?: string) {
  return getZalouserRuntime().channel.text.resolveChunkMode(cfg, "zalouser", accountId);
}

function resolveZalouserOutboundTextChunkLimit(cfg: PowerDirectorConfig, accountId?: string) {
