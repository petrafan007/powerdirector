...
import { formatZalouserMessageSidFull, resolveZalouserMessageSid } from "./message-sid";
...
import type { ResolvedZalouserAccount, ZaloInboundMessage } from "./types";
import {
  listZaloFriends,
  listZaloGroups,
...
function resolveZalouserDmSessionScope(config: PowerDirectorConfig) {
