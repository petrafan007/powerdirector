...
import type { ResolvedZalouserAccount, ZalouserAccountConfig, ZalouserConfig } from "./types";
import { checkZaloAuthenticated, getZaloUserInfo } from "./zalo-js";
...
function mergeZalouserAccountConfig(cfg: PowerDirectorConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: PowerDirectorConfig; accountId?: string | null }) {
...
export type { ResolvedZalouserAccount } from "./types";
