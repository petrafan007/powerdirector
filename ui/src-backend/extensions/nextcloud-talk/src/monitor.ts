...
import { resolveNextcloudTalkAccount } from "./accounts";
import { handleNextcloudTalkInbound } from "./inbound";
import { createNextcloudTalkReplayGuard } from "./replay-guard";
import { getNextcloudTalkRuntime } from "./runtime";
import { extractNextcloudTalkHeaders, verifyNextcloudTalkSignature } from "./signature";
import type {
  CoreConfig,
