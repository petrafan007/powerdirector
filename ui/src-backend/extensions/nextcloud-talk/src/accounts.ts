...
import { normalizeResolvedSecretInputString } from "./secret-input";
import type { CoreConfig, NextcloudTalkAccountConfig } from "./types";
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.POWERDIRECTOR_DEBUG_NEXTCLOUD_TALK_ACCOUNTS)) {
