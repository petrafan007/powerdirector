...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set POWERDIRECTOR_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `powerdirector dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control PowerDirector.");
  } else if (hint) {
    runtime.log(hint);
  }
}
