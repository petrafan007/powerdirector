...
import { formatImageMatch, formatSimpleStatus, formatStatus } from './sandbox-formatters';
...
export function displaySummary(
  ...
  if (mismatchCount > 0) {
    ...
    runtime.log(
      `   Run '${formatCliCommand("powerdirector sandbox recreate --all")}' to update all containers.`,
    );
  }
}
