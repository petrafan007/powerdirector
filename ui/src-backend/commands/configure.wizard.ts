...
import { resolveSetupSecretInputString } from "../wizard/setup.secret-input";
...
async function runGatewayHealthCheck(params: {
  ...
  const token =
    process.env.POWERDIRECTOR_GATEWAY_TOKEN ?? process.env.CLAWDBOT_GATEWAY_TOKEN ?? configuredToken;
  const password =
