import { CONTEXT_WINDOW_HARD_MIN_TOKENS } from "../agents/context-window-guard";
...
import { isSecretRef, type SecretInput } from "../config/types.secrets";
...
import { ensureApiKeyFromEnvOrPrompt } from "./auth-choice.apply-helpers";
...
export function applyCustomApiConfig(params: ApplyCustomApiConfigParams): CustomApiResult {
  ...
  let config: PowerDirectorConfig = {
    ...params.config,
    models: {
