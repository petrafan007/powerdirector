...
function resolveDefaultAccountId(cfg: PowerDirectorConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: PowerDirectorConfig): boolean {
...
export function summarizeBindings(cfg: PowerDirectorConfig, bindings: AgentBinding[]): string[] {
