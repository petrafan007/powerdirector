...
let sshConfigModulePromise: Promise<typeof import("../infra/ssh-config")> | undefined;
let sshTunnelModulePromise: Promise<typeof import("../infra/ssh-tunnel")> | undefined;

function loadSshConfigModule() {
  sshConfigModulePromise ??= import("../infra/ssh-config");
  return sshConfigModulePromise;
}

function loadSshTunnelModule() {
  sshTunnelModulePromise ??= import("../infra/ssh-tunnel");
