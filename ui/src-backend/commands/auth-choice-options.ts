...
import { resolveManifestProviderAuthChoices } from "../plugins/provider-auth-choices";
import { resolveProviderWizardOptions } from "../plugins/provider-wizard";
import {
  CORE_AUTH_CHOICE_OPTIONS,
  type AuthChoiceGroup,
  type AuthChoiceOption,
  formatStaticAuthChoiceChoicesForCli,
} from "./auth-choice-options.static";
import type { AuthChoice, AuthChoiceGroupId } from "./onboard-types";
