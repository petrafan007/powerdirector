...
describe("onboard (non-interactive): gateway and remote auth", () => {
  const prev = {
    ...
    password: process.env.POWERDIRECTOR_GATEWAY_PASSWORD,
  };
  ...
  beforeAll(async () => {
    ...
    tempHome = await makeTempWorkspace("powerdirector-onboard-");
  ...
  afterAll(async () => {
    ...
    process.env.POWERDIRECTOR_GATEWAY_PASSWORD = prev.password;
  });
