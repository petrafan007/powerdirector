...
import { coerceSecretRef, normalizeSecretInputString } from "../../config/types.secrets";
import { type SecretRefResolveCache, resolveSecretRefString } from "../../secrets/resolve";
...
function resolveProbeSecretRef(profile: AuthProfileCredential, cfg: PowerDirectorConfig) {
