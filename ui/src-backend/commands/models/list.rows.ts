...
import { shouldSuppressBuiltInModel } from "../../agents/model-suppression";
import { resolveModelWithRegistry } from "../../agents/pi-embedded-runner/model";
import type { PowerDirectorConfig } from "../../config/config";
import { loadModelRegistry, toModelRow } from "./list.registry";
import type { ConfiguredEntry, ModelRow } from "./list.types";
...
export async function loadListModelRegistry(
  cfg: PowerDirectorConfig,
  opts?: { sourceConfig?: PowerDirectorConfig },
) {
