...
import { loadModelsConfigWithSource } from "./load-config";
import { DEFAULT_PROVIDER, ensureFlagCompatibility } from "./shared";
...
export async function modelsListCommand(
  ...
  const { ensurePowerDirectorModelsJson } = await import("../../agents/models-config");
  ...
  try {
    ...
    await ensurePowerDirectorModelsJson(sourceConfig ?? cfg);
