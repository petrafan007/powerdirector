import type { ApiKeyCredential } from "../../../agents/auth-profiles/types";
import type { PowerDirectorConfig } from "../../../config/config";
import type { SecretInput } from "../../../config/types.secrets";
import { applyAuthProfileConfig } from "../../../plugins/provider-auth-helpers";
import { setCloudflareAiGatewayConfig } from "../../../plugins/provider-auth-storage";
import type { RuntimeEnv } from "../../../runtime";
import { resolveDefaultSecretProviderAlias } from "../../../secrets/ref-contract";
import { normalizeSecretInputModeInput } from "../../auth-choice.apply-helpers";
import { normalizeApiKeyTokenProviderAuthChoice } from "../../auth-choice.apply.api-providers";
import { applyCloudflareAiGatewayConfig } from "../../onboard-auth.config-gateways";
import {
...
import { applySimpleNonInteractiveApiKeyChoice } from "./auth-choice.api-key-providers";
import { applyNonInteractivePluginProviderChoice } from "./auth-choice.plugin-providers";
