...
import { KILOCODE_BASE_URL } from "../providers/kilocode-shared";
import {
...
export function applyOpenrouterProviderConfig(cfg: PowerDirectorConfig): PowerDirectorConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: PowerDirectorConfig): PowerDirectorConfig {
...
export function applyKimiCodeProviderConfig(cfg: PowerDirectorConfig): PowerDirectorConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiProviderConfig(cfg: PowerDirectorConfig): PowerDirectorConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: PowerDirectorConfig): PowerDirectorConfig {
...
export function applyQianfanProviderConfig(cfg: PowerDirectorConfig): PowerDirectorConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: PowerDirectorConfig): PowerDirectorConfig {
