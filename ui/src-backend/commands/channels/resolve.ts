...
import type { ChannelResolveKind, ChannelResolveResult } from "../../channels/plugins/types";
...
import { resolveInstallableChannelPlugin } from "../channel-setup/channel-plugin-resolution";
