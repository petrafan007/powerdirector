...
import { DEFAULT_LOCAL_MODEL } from "../memory/embeddings";
import { hasConfiguredMemorySecretInput } from "../memory/secret-input";
  ...
  if (resolved.provider !== "auto") {
    ...
    note(
      [
        ...
        `- Configure credentials: ${formatCliCommand("powerdirector configure --section model")}`,
