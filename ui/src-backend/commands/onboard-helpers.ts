...
export function summarizeExistingConfig(config: PowerDirectorConfig): string {
  const rows: string[] = [];
...
export function formatControlUiSshHint(params: {
  ...
  return [
    ...
    authedUrl,
    "Docs:",
    "https://docs.powerdirector.ai/gateway/remote",
    "https://docs.powerdirector.ai/web/control-ui",
  ]
    .filter(Boolean)
    .join("\n");
}
