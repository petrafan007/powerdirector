...
import { resolveBundledInstallPlanForCatalogEntry } from "../../cli/plugin-install-plan";
...
import { clearPluginDiscoveryCache } from "../../plugins/discovery";
import { enablePluginInConfig } from "../../plugins/enable";
import { installPluginFromNpmSpec } from "../../plugins/install";
import { buildNpmResolutionInstallFields, recordPluginInstall } from "../../plugins/installs";
...
function addPluginLoadPath(cfg: PowerDirectorConfig, pluginPath: string): PowerDirectorConfig {
