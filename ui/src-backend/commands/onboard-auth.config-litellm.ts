...
export function applyLitellmProviderConfig(cfg: PowerDirectorConfig): PowerDirectorConfig {
...
export function applyLitellmConfig(cfg: PowerDirectorConfig): PowerDirectorConfig {
