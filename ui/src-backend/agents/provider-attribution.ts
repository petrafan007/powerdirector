import type { RuntimeVersionEnv } from "../version";
...
const POWERDIRECTOR_ATTRIBUTION_PRODUCT = "PowerDirector";
const POWERDIRECTOR_ATTRIBUTION_ORIGINATOR = "powerdirector";

export function resolveProviderAttributionIdentity(
  env: RuntimeVersionEnv = process.env as RuntimeVersionEnv,
): ProviderAttributionIdentity {
  return {
    product: POWERDIRECTOR_ATTRIBUTION_PRODUCT,
...
function buildOpenAIAttributionPolicy(
  ...
  return {
    ...
    ...identity,
    headers: {
      originator: POWERDIRECTOR_ATTRIBUTION_ORIGINATOR,
      "User-Agent": `${POWERDIRECTOR_ATTRIBUTION_ORIGINATOR}/${identity.version}`,
    },
  };
}
