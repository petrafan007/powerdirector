...
import { resolveStoredSubagentCapabilities } from "./subagent-capabilities";
import {
...
export async function killSubagentRunAdmin(params: { cfg: PowerDirectorConfig; sessionKey: string }) {
