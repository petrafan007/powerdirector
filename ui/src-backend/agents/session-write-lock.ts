...
import { getProcessStartTime, isPidAlive } from "../shared/pid-alive";
...
const CLEANUP_STATE_KEY = Symbol.for("powerdirector.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("powerdirector.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("powerdirector.sessionWriteLockWatchdogState");
