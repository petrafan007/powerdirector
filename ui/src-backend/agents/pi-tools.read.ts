...
import { toRelativeWorkspacePath } from "./path-policy";
import { wrapHostEditToolWithPostWriteRecovery } from "./pi-tools.host-edit";
import {
  CLAUDE_PARAM_GROUPS,
...
type PowerDirectorReadToolOptions = {
...
function resolveAdaptiveReadMaxBytes(options?: PowerDirectorReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createPowerDirectorReadTool(base, {
...
export function createPowerDirectorReadTool(
  base: AnyAgentTool,
  options?: PowerDirectorReadToolOptions,
): AnyAgentTool {
