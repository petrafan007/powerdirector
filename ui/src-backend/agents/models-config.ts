...
import { createConfigRuntimeEnv } from "../config/env-vars";
import { resolvePowerDirectorAgentDir } from "./agent-paths";
import { planPowerDirectorModelsJson } from "./models-config.plan";
...
export async function ensurePowerDirectorModelsJson(
  config?: PowerDirectorConfig,
