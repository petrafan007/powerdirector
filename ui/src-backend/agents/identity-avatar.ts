...
function resolveAvatarSource(cfg: PowerDirectorConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: PowerDirectorConfig, agentId: string): AgentAvatarResolution {
