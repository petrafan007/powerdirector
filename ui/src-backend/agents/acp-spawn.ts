...
} from "../acp/control-plane/spawn";
import { isAcpEnabledByPolicy, resolveAcpAgentPolicyError } from "../acp/policy";
import {
  resolveAcpSessionCwd,
  resolveAcpThreadSessionDetailLines,
} from "../acp/runtime/session-identifiers";
import type { AcpRuntimeSessionMode } from "../acp/runtime/types";
import { DEFAULT_HEARTBEAT_EVERY } from "../auto-reply/heartbeat";
import {
  resolveThreadBindingIntroText,
  resolveThreadBindingThreadName,
} from "../channels/thread-bindings-messages";
import {
...
} from "../channels/thread-bindings-policy";
import { parseDurationMs } from "../cli/parse-duration";
import { loadConfig } from "../config/config";
import type { PowerDirectorConfig } from "../config/config";
import { loadSessionStore, resolveStorePath, type SessionEntry } from "../config/sessions";
import { resolveSessionTranscriptFile } from "../config/sessions/transcript";
import { callGateway } from "../gateway/call";
import { areHeartbeatsEnabled } from "../infra/heartbeat-wake";
import { resolveConversationIdFromTargets } from "../infra/outbound/conversation-id";
import {
...
import { deliveryContextFromSession, normalizeDeliveryContext } from "../utils/delivery-context";
import {
  type AcpSpawnParentRelayHandle,
  resolveAcpSpawnStreamLogPath,
  startAcpSpawnParentStreamRelay,
} from "./acp-spawn-parent-stream";
import { resolveAgentConfig, resolveDefaultAgentId } from "./agent-scope";
import { resolveSandboxRuntimeStatus } from "./sandbox/runtime-status";
import { resolveInternalSessionKey, resolveMainSessionAlias } from "./tools/sessions-helpers";
...
function resolveHeartbeatConfigForAgent(params: {
  cfg: PowerDirectorConfig;
  agentId: string;
}): NonNullable<NonNullable<PowerDirectorConfig["agents"]>["defaults"]>["heartbeat"] {
