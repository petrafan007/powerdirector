...
let providerRuntimePromise:
  ...
  | undefined;
let modelSuppressionPromise: Promise<typeof import("./model-suppression.runtime")> | undefined;
...
function loadModelSuppression() {
  modelSuppressionPromise ??= import("./model-suppression.runtime");
...
function readConfiguredOptInProviderModels(config: PowerDirectorConfig): ModelCatalogEntry[] {
