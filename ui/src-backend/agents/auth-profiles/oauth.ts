...
import { resolveSecretRefString, type SecretRefResolveCache } from "../../secrets/resolve";
import { refreshChutesTokens } from "../chutes-oauth";
import { AUTH_STORE_LOCK_OPTIONS, log } from "./constants";
import { resolveTokenExpiryState } from "./credential-state";
...
import type { AuthProfileStore, OAuthCredential } from "./types";
...
async function resolveProfileSecretString(params: {
  ...
  configForRefResolution: PowerDirectorConfig;
