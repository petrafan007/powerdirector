...
import { buildSandboxCreateArgs, type SandboxDockerConfig } from './sandbox';
...
describe("buildSandboxCreateArgs", () => {
  ...
  it("throws on dangerous bind mounts (Docker socket)", () => {
    ...
    expect(() =>
      buildSandboxCreateArgs({
        name: "powerdirector-sbx-dangerous",
        cfg,
        scopeKey: "main",
        createdAtMs: 1700000000000,
      }),
  ...
  it("throws on dangerous bind mounts (parent path)", () => {
    ...
    expect(() =>
      buildSandboxCreateArgs({
        name: "powerdirector-sbx-dangerous-parent",
        cfg,
        scopeKey: "main",
        createdAtMs: 1700000000000,
      }),
  ...
  it("throws on seccomp unconfined", () => {
    ...
    expect(() =>
      buildSandboxCreateArgs({
        name: "powerdirector-sbx-seccomp",
        cfg,
        scopeKey: "main",
        createdAtMs: 1700000000000,
      }),
  ...
  it("throws on apparmor unconfined", () => {
    ...
    expect(() =>
      buildSandboxCreateArgs({
        name: "powerdirector-sbx-apparmor",
        cfg,
        scopeKey: "main",
        createdAtMs: 1700000000000,
      }),
