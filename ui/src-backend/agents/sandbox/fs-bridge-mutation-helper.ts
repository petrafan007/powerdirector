import { PATH_ALIAS_POLICIES } from "../../infra/path-alias-guards";
import type {
  PathSafetyCheck,
  PinnedSandboxDirectoryEntry,
  PinnedSandboxEntry,
} from "./fs-bridge-path-safety";
import type { SandboxFsCommandPlan } from "./fs-bridge-shell-command-plans";
...
export const SANDBOX_PINNED_MUTATION_PYTHON = [
  ...
  "    prefix = '.powerdirector-move-' + basename + '.'",
  "    for _ in range(128):",
  "        candidate = prefix + secrets.token_hex(6)",
  "        try:",
