...
import type { SandboxBackendCommandResult } from "./backend";
import { runDockerSandboxShellCommand } from "./docker-backend";
import {
  buildPinnedMkdirpPlan,
  buildPinnedRemovePlan,
  buildPinnedRenamePlan,
  buildPinnedWritePlan,
} from "./fs-bridge-mutation-helper";
import { SandboxFsPathGuard } from "./fs-bridge-path-safety";
import { buildStatPlan, type SandboxFsCommandPlan } from "./fs-bridge-shell-command-plans";
import {
