...
import { formatSandboxToolPolicyBlockedMessage } from "../sandbox";
...
export function formatAssistantErrorText(
  ...
  opts?: { cfg?: PowerDirectorConfig; sessionKey?: string; provider?: string; model?: string },
): string | undefined {
...
export function isModelNotFoundErrorMessage(raw: string): boolean {
  ...
  // Direct pattern matches from PowerDirector internals and common providers.
  if (
