...
import { prepareProviderRuntimeAuth } from "../../plugins/provider-runtime";
...
import { resolveSessionAgentId, resolveSessionAgentIds } from "../agent-scope";
...
import { DEFAULT_CONTEXT_TOKENS, DEFAULT_MODEL, DEFAULT_PROVIDER } from "../defaults";
...
import { ensureRuntimePluginsLoaded } from "../runtime-plugins";
...
import { buildModelAliasLines, resolveModelAsync } from "./model";
...
function resolvePostCompactionIndexSyncMode(config?: PowerDirectorConfig): "off" | "async" | "await" {
...
export async function compactEmbeddedPiSessionDirect(
  ...
  await ensurePowerDirectorModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createPowerDirectorCodingTools({
      exec: {
