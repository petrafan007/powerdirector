...
import { ensureContextEnginesInitialized } from "../context-engine/init";
import { resolveContextEngine } from "../context-engine/registry";
import type { SubagentEndReason } from "../context-engine/types";
import { callGateway } from "../gateway/call";
import { onAgentEvent } from "../infra/agent-events";
import { createSubsystemLogger } from "../logging/subsystem";
import { defaultRuntime } from "../runtime";
import { emitSessionLifecycleEvent } from "../sessions/session-lifecycle-events";
...
} from "./subagent-lifecycle-events";
import {
  resolveCleanupCompletionReason,
  resolveDeferredCleanupDecision,
} from "./subagent-registry-cleanup";
import {
  emitSubagentEndedHookOnce,
  resolveLifecycleOutcomeFromRunOutcome,
  runOutcomesEqual,
} from "./subagent-registry-completion";
import {
...
} from "./subagent-registry-queries";
import {
  getSubagentRunsSnapshotForRead,
  persistSubagentRunsToDisk,
  restoreSubagentRunsFromDisk,
} from "./subagent-registry-state";
import type { SubagentRunRecord } from "./subagent-registry.types";
import { resolveAgentTimeoutMs } from "./timeout";

export type { SubagentRunRecord } from "./subagent-registry.types";
...
function restoreSubagentRunsOnce() {
  ...
  try {
    ...
    void import("./subagent-orphan-recovery").then(
