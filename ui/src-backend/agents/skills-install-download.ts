...
import { assertCanonicalPathWithinBase } from "../infra/install-safe-path";
...
import { extractArchive } from "./skills-install-extract";
...
async function downloadFile(params: {
  ...
  const stagingDir = path.join(params.rootDir, ".powerdirector-download-staging");
