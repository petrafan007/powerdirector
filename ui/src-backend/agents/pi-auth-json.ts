...
import type { AuthProfileCredential } from './auth-profiles/types';
...
/**
 * Convert an PowerDirector auth-profiles credential to pi-coding-agent auth.json format.
 ...
 *
 * PowerDirector stores credentials in auth-profiles.json instead. This helper
