import { resolveThinkingDefaultForModel } from "../auto-reply/thinking.shared";
...
import { splitTrailingAuthProfile } from "./model-ref-profile";
import {
...
function resolveAllowedFallbacks(params: { cfg: PowerDirectorConfig; agentId?: string }): string[] {
  if (params.agentId) {
