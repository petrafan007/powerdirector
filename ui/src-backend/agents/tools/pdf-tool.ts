...
import { extractPdfContent, type PdfExtractedContent } from "../../media/pdf-extract";
import { loadWebMediaRaw } from "../../media/web-media";
...
} from "./media-tool-shared";
import { hasAuthForProvider, resolveDefaultModelRef } from "./model-config.helpers";
import { anthropicAnalyzePdf, geminiAnalyzePdf } from "./pdf-native-providers";
import {
...
async function runPdfPrompt(params: {
  ...
  await ensurePowerDirectorModelsJson(effectiveCfg, params.agentDir);
