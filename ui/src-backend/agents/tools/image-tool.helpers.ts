...
import { coerceToolModelConfig, type ToolModelConfig } from "./model-config.helpers";
...
export function coerceImageModelConfig(cfg?: PowerDirectorConfig): ImageModelConfig {
