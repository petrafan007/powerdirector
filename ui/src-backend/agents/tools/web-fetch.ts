...
import type { RuntimeWebFetchFirecrawlMetadata } from "../../secrets/runtime-web-tools";
...
import { fetchWithWebToolsNetworkGuard, withTrustedWebToolsEndpoint } from "./web-guarded-fetch";
import {
  CacheEntry,
