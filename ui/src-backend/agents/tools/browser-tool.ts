...
import { DEFAULT_UPLOAD_DIR, resolveExistingPathsWithinRoot } from "../../browser/paths";
import { getBrowserProfileCapabilities } from "../../browser/profile-capabilities";
import { applyBrowserProxyPaths, persistBrowserProxyFiles } from "../../browser/proxy-files";
import {
  trackSessionBrowserTab,
  untrackSessionBrowserTab,
} from "../../browser/session-tab-registry";
...
export function createBrowserTool(opts?: {
  ...
  return {
    ...
    description: [
      ...
      "Browser choice: omit profile by default for the isolated PowerDirector-managed browser (`powerdirector`).",
