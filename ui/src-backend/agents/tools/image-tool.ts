...
import { getMediaUnderstandingProvider } from "../../media-understanding/providers/index";
import { buildProviderRegistry } from "../../media-understanding/runner";
import { loadWebMedia } from "../../media/web-media";
import { resolveUserPath } from "../../utils";
import { isMinimaxVlmProvider } from "../minimax-vlm";
import {
...
function pickMaxBytes(cfg?: PowerDirectorConfig, maxBytesMb?: number): number | undefined {
...
async function runImagePrompt(params: {
  ...
  const providerCfg: PowerDirectorConfig = effectiveCfg ?? {};
