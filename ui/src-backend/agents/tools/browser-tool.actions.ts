...
import { browserAct, browserConsoleMessages } from "../../browser/client-actions";
import { browserSnapshot, browserTabs } from "../../browser/client";
...
import { imageResultFromFile, jsonResult } from "./common";
