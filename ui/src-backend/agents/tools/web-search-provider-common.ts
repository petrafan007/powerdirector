...
import { withTrustedWebToolsEndpoint } from "./web-guarded-fetch";
import {
  CacheEntry,
...
export type SearchConfigRecord = (NonNullable<PowerDirectorConfig["tools"]>["web"] extends infer Web
...
const SEARCH_CACHE_KEY = Symbol.for("powerdirector.web-search.cache");
