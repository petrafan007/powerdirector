...
import { getImageMetadata } from "../../media/image-ops";
import { saveMediaBuffer } from "../../media/store";
import { loadWebMedia } from "../../media/web-media";
import { resolveUserPath } from "../../utils";
import { ToolInputError, readNumberParam, readStringParam } from "./common";
import { decodeDataUrl } from "./image-tool.helpers";
import {
...
const ImageGenerateToolSchema = Type.Object({
  ...
  filename: Type.Optional(
    Type.String({
      description:
        "Optional output filename hint. PowerDirector preserves the basename and saves under its managed media directory.",
    }),
  ),
  size: Type.Optional(
    Type.String({
