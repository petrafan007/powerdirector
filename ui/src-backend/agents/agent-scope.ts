...
export function listAgentEntries(cfg: PowerDirectorConfig): AgentEntry[] {
...
export function listAgentIds(cfg: PowerDirectorConfig): string[] {
...
export function resolveDefaultAgentId(cfg: PowerDirectorConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
export function resolveSessionAgentIds(params: { sessionKey?: string; config?: PowerDirectorConfig }): {
...
function resolveAgentEntry(cfg: PowerDirectorConfig, agentId: string): AgentEntry | undefined {
...
export function resolveAgentModelPrimary(cfg: PowerDirectorConfig, agentId: string): string | undefined {
...
export function resolveAgentWorkspaceDir(cfg: PowerDirectorConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentDir(cfg: PowerDirectorConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
