...
import { isAcpRuntimeError } from "../../acp/runtime/errors";
import { resolveTextChunkLimit } from "../../auto-reply/chunk";
import type { NativeCommandSpec } from "../../auto-reply/commands-registry";
...
import { isDangerousNameMatchingEnabled } from "../../config/dangerous-name-matching";
import {
...
import { getPluginCommandSpecs } from "../../plugins/commands";
...
import { createDiscordVoiceCommand } from "../voice/command";
import { DiscordVoiceManager, DiscordVoiceReadyListener } from "../voice/manager";
import {
...
import { createDiscordAutoPresenceController } from "./auto-presence";
import { resolveDiscordSlashCommandConfig } from "./commands";
import { createExecApprovalButton, DiscordExecApprovalHandler } from "./exec-approvals";
import { attachEarlyGatewayErrorGuard } from "./gateway-error-guard";
...
import { resolveDiscordAllowlistConfig } from "./provider.allowlist";
import { runDiscordGatewayLifecycle } from "./provider.lifecycle";
...
import { formatThreadBindingDurationLabel } from "./thread-bindings.messages";
