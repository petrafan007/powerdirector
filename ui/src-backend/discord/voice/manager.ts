...
import { agentCommandFromIngress } from "../../commands/agent";
import type { PowerDirectorConfig } from "../../config/config";
import { isDangerousNameMatchingEnabled } from "../../config/dangerous-name-matching";
import type { DiscordAccountConfig, TtsConfig } from "../../config/types";
...
import {
  ...
  runCapability,
} from "../../media-understanding/runner";
import { resolveAgentRoute } from "../../routing/resolve-route";
import type { RuntimeEnv } from "../../runtime";
import { parseTtsDirectives } from "../../tts/tts-core";
import { resolveTtsConfig, textToSpeech, type ResolvedTtsConfig } from "../../tts/tts";
