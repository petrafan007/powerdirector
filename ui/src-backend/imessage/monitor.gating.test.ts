...
function baseCfg(): PowerDirectorConfig {
  return {
    ...
    messages: {
      groupChat: { mentionPatterns: ["@powerdirector"] },
    },
...
function buildDispatchContextPayload(params: { cfg: PowerDirectorConfig; message: IMessagePayload }) {
  ...
  it("blocks group messages when imessage.groups is set without a wildcard", () => {
    ...
    const decision = resolveIMessageInboundDecision({
      ...
      message: {
        ...
        sender: "+15550001111",
        is_from_me: false,
        text: "@powerdirector hello",
        is_group: true,
      },
      opts: {},
      messageText: "@powerdirector hello",
      bodyText: "@powerdirector hello",
      allowFrom: ["*"],
      groupAllowFrom: [],
      groupPolicy: "open",
      dmPolicy: "open",
  ...
  it("honors group allowlist and ignores pairing-store senders in groups", () => {
    ...
    const denied = resolveIMessageInboundDecision({
      ...
      message: {
        ...
        sender: "+15550003333",
        is_from_me: false,
        text: "@powerdirector hi",
        is_group: true,
      },
      opts: {},
      messageText: "@powerdirector hi",
      bodyText: "@powerdirector hi",
      allowFrom: ["*"],
    ...
    const allowed = resolveIMessageInboundDecision({
      ...
      message: {
        ...
        sender: "+15550003333",
        is_from_me: false,
        text: "@powerdirector ok",
        is_group: true,
      },
      opts: {},
      messageText: "@powerdirector ok",
      bodyText: "@powerdirector ok",
      allowFrom: ["*"],
      groupAllowFrom: ["chat_id:101"],
      groupPolicy: "allowlist",
      dmPolicy: "pairing",
