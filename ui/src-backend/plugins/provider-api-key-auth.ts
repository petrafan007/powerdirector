import { upsertAuthProfile } from "../agents/auth-profiles/profiles";
...
type ProviderApiKeyAuthMethodOptions = {
  ...
  noteMessage?: string;
  noteTitle?: string;
  applyConfig?: (cfg: PowerDirectorConfig) => PowerDirectorConfig;
};

const loadProviderApiKeyAuthRuntime = createLazyRuntimeSurface(
  () => import("./provider-api-key-auth.runtime"),
