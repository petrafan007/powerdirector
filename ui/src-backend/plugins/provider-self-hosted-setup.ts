import type { ApiKeyCredential, AuthProfileCredential } from "../agents/auth-profiles/types";
import { upsertAuthProfileWithLock } from "../agents/auth-profiles/upsert-with-lock";
import {
  SELF_HOSTED_DEFAULT_CONTEXT_WINDOW,
  SELF_HOSTED_DEFAULT_COST,
  SELF_HOSTED_DEFAULT_MAX_TOKENS,
} from "../agents/self-hosted-provider-defaults";
...
export function applyProviderDefaultModel(cfg: PowerDirectorConfig, modelRef: string): PowerDirectorConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  maxTokens?: number;
}): { config: PowerDirectorConfig; modelId: string; modelRef: string; profileId: string } {
