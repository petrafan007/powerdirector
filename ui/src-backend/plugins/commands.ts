...
function listPluginInvocationKeys(command: PowerDirectorPluginCommandDefinition): string[] {
...
function listPluginInvocationNames(command: PowerDirectorPluginCommandDefinition): string[] {
