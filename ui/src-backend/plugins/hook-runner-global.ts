...
import type { PluginHookGatewayContext, PluginHookGatewayStopEvent } from "./types";
...
const hookRunnerGlobalStateKey = Symbol.for("powerdirector.plugins.hook-runner-global-state");
