...
import { DEFAULT_PLUGIN_ENTRY_CANDIDATES, PLUGIN_MANIFEST_FILENAME } from "./manifest";
import type { PluginBundleFormat } from "./types";
...
export type BundlePluginManifest = {
  ...
  // Only include hook roots that PowerDirector can execute via HOOK.md + handler files.
  hooks: string[];
