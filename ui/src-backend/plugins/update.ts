...
import { resolveBundledPluginSources } from "./bundled-sources";
import {
...
import { buildNpmResolutionInstallFields, recordPluginInstall } from "./installs";
...
function migratePluginConfigId(cfg: PowerDirectorConfig, fromId: string, toId: string): PowerDirectorConfig {
  if (fromId === toId) {
    return cfg;
  }
