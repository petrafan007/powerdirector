...
function resolveHookDir(api: PowerDirectorPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: PowerDirectorPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
