...
describe("loader", () => {
  ...
  beforeAll(async () => {
    fixtureRoot = await fs.mkdtemp(path.join(os.tmpdir(), "powerdirector-hooks-loader-"));
  });
  ...
  beforeEach(async () => {
    ...
    originalBundledDir = process.env.POWERDIRECTOR_BUNDLED_HOOKS_DIR;
  ...
  afterEach(async () => {
    ...
    if (originalBundledDir === undefined) {
      ...
      process.env.POWERDIRECTOR_BUNDLED_HOOKS_DIR = originalBundledDir;
    }
  });
