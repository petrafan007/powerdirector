...
import { resolveFunctionModuleExport } from "./module-loader";
 ...
 *
 * @param cfg - PowerDirector configuration
...
export async function loadInternalHooks(
  ...
  for (const handlerConfig of handlers) {
    try {
      ...
      const importUrl = buildImportUrl(safeModulePath, "powerdirector-workspace");
      const mod = (await import(importUrl)) as Record<string, unknown>;
