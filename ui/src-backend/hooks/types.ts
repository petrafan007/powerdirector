...
export type PowerDirectorHookMetadata = {
  always?: boolean;
  hookKey?: string;
  emoji?: string;
  homepage?: string;
...
export type Hook = {
  name: string;
  description: string;
  source: "powerdirector-bundled" | "powerdirector-managed" | "powerdirector-workspace" | "powerdirector-plugin";
  pluginId?: string;
...
export type HookEntry = {
  ...
  metadata?: PowerDirectorHookMetadata;
