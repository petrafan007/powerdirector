...
import { isInterpreterLikeSafeBin } from "../infra/exec-safe-bin-runtime-policy";
import {
  POSIX_SHELL_WRAPPERS,
  normalizeExecutableToken,
  unwrapKnownDispatchWrapperInvocation,
  unwrapKnownShellMultiplexerInvocation,
} from "../infra/exec-wrapper-resolution";
import { sameFileIdentity } from "../infra/file-identity";
import {
  POSIX_INLINE_COMMAND_FLAGS,
  resolveInlineCommandMatch,
} from "../infra/shell-inline-command";
import { formatExecCommand, resolveSystemRunCommandRequest } from "../infra/system-run-command";
