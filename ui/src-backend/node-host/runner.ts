...
import type { SkillBinTrustEntry } from "../infra/exec-approvals";
import { resolveExecutableFromPathEnv } from "../infra/executable-path";
import { getMachineDisplayName } from "../infra/machine-name";
import {
  NODE_BROWSER_PROXY_COMMAND,
  NODE_EXEC_APPROVALS_COMMANDS,
  NODE_SYSTEM_RUN_COMMANDS,
} from "../infra/node-commands";
...
function ensureNodePathEnv(): string {
  ensurePowerDirectorCliOnPath({ pathEnv: process.env.PATH ?? "" });
...
function buildNodeHostLocalAuthConfig(config: PowerDirectorConfig): PowerDirectorConfig {
