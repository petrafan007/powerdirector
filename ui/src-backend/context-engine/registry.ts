...
import { defaultSlotIdForKey } from "../plugins/slots";
...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("powerdirector.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("powerdirector.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: PowerDirectorConfig): Promise<ContextEngine> {
