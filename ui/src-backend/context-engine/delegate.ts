import type { ContextEngine, CompactResult, ContextEngineRuntimeContext } from "./types";

/**
 * Delegate a context-engine compaction request to PowerDirector's built-in runtime compaction path.
 *
...
export async function delegateCompactionToRuntime(
  ...
  const { compactEmbeddedPiSessionDirect } =
    await import("../agents/pi-embedded-runner/compact.runtime");
