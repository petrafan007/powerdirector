...
export function listBoundAccountIds(cfg: PowerDirectorConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: PowerDirectorConfig) {
