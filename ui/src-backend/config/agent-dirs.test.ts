...
import { findDuplicateAgentDirs } from './agent-dirs';
...
describe("resolveEffectiveAgentDir via findDuplicateAgentDirs", () => {
  it("uses POWERDIRECTOR_HOME for default agent dir resolution", () => {
  ...
  it("resolves agent dir under POWERDIRECTOR_HOME state dir", () => {
