import type { CommonChannelMessagingConfig } from "./types.channel-messaging-common";
...
export type IrcAccountConfig = CommonChannelMessagingConfig & {
  ...
  username?: string;
  /** IRC USER field realname (default: PowerDirector). */
  realname?: string;
  ...
  /** Auto-join channel list at connect (example: ["#powerdirector"]). */
  channels?: string[];
