...
import type { ConfigUiHints } from "../shared/config-ui-hints-types";
import { FIELD_HELP } from "./schema.help";
import { FIELD_LABELS } from "./schema.labels";
import { applyDerivedTags } from "./schema.tags";
import { sensitive } from "./zod-schema.sensitive";

const log = createSubsystemLogger("config/schema");

export type { ConfigUiHint, ConfigUiHints } from "../shared/config-ui-hints-types";
...
const FIELD_PLACEHOLDERS: Record<string, string> = {
  ...
  "gateway.controlUi.basePath": "/powerdirector",
  "gateway.controlUi.root": "dist/control-ui",
  "gateway.controlUi.allowedOrigins": "https://control.example.com",
  "gateway.push.apns.relay.baseUrl": "https://relay.example.com",
  "channels.mattermost.baseUrl": "https://chat.example.com",
  "agents.list[].identity.avatar": "avatars/powerdirector.png",
};
