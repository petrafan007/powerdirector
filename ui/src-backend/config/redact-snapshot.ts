...
import { stripUrlUserInfo } from "../shared/net/url-userinfo";
import {
  replaceSensitiveValuesInRaw,
  shouldFallbackToStructuredRawRedaction,
} from "./redact-snapshot.raw";
import { isSecretRefShape, redactSecretRefId } from "./redact-snapshot.secret-ref";
 ...
 */
export const REDACTED_SENTINEL = "__POWERDIRECTOR_REDACTED__";
