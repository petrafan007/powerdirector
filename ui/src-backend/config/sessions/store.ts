...
import { getFileStatSnapshot, isCacheEnabled, resolveCacheTtlMs } from "../cache-utils";
import { enforceSessionDiskBudget, type SessionDiskBudgetSweepResult } from "./disk-budget";
...
import { applySessionStoreMigrations } from "./store-migrations";
import {
  mergeSessionEntry,
...
function getSessionStoreTtl(): number {
  return resolveCacheTtlMs({
    envValue: process.env.POWERDIRECTOR_SESSION_CACHE_TTL_MS,
