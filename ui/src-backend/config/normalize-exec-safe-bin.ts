import { normalizeSafeBinProfileFixtures } from "../infra/exec-safe-bin-policy";
import { normalizeTrustedSafeBinDirs } from "../infra/exec-safe-bin-trust";
import type { PowerDirectorConfig } from "./types";

export function normalizeExecSafeBinProfilesInConfig(cfg: PowerDirectorConfig): void {
