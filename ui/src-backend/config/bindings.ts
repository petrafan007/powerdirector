...
import type { AgentAcpBinding, AgentBinding, AgentRouteBinding } from "./types.agents";
...
export function listConfiguredBindings(cfg: PowerDirectorConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listRouteBindings(cfg: PowerDirectorConfig): AgentRouteBinding[] {
  return listConfiguredBindings(cfg).filter(isRouteBinding);
}

export function listAcpBindings(cfg: PowerDirectorConfig): AgentAcpBinding[] {
