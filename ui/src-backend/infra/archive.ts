...
import { openFileWithinRoot, openWritableFileWithinRoot, SafeOpenError } from "./fs-safe";
...
export { ArchiveSecurityError, type ArchiveSecurityErrorCode } from "./archive-staging";
export {
  mergeExtractedTreeIntoDestination,
  prepareArchiveDestinationDir,
  prepareArchiveOutputPath,
