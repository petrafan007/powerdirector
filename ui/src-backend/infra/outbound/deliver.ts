...
import { resolveOutboundChannelPlugin } from "./channel-resolution";
import { ackDelivery, enqueueDelivery, failDelivery } from "./delivery-queue";
import type { OutboundIdentity } from "./identity";
import type { DeliveryMirror } from "./mirror";
import type { NormalizedOutboundPayload } from "./payloads";
import { normalizeReplyPayloadsForDelivery } from "./payloads";
import { isPlainTextSurface, sanitizeForPlainText } from "./sanitize-text";
import { resolveOutboundSendDep, type OutboundSendDeps } from "./send-deps";
import type { OutboundSessionContext } from "./session-context";
...
export { resolveOutboundSendDep, type OutboundSendDeps } from "./send-deps";
...
function normalizePayloadsForChannelDelivery(
  ...
  for (const payload of normalizeReplyPayloadsForDelivery(payloads)) {
    ...
    // See https://github.com/powerdirector/powerdirector/issues/31884
