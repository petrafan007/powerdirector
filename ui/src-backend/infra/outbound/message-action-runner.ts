...
import { hasInteractiveReplyBlocks, hasReplyPayloadContent } from "../../interactive/payload";
import { getAgentScopedMediaLocalRoots } from "../../media/local-roots";
import { hasPollCreationParams, resolveTelegramPollVisibility } from "../../poll-params";
import { resolvePollMaxSelections } from "../../polls";
import { buildChannelAccountBindings } from "../../routing/bindings";
import { normalizeAgentId } from "../../routing/session-key";
import { type GatewayClientMode, type GatewayClientName } from "../../utils/message-channel";
...
import { normalizeMessageActionInput } from "./message-action-normalization";
import {
