...
import type { DeliverOutboundPayloadsParams, OutboundDeliveryResult } from "./deliver";
...
vi.mock("../../config/sessions/transcript", async () => {
  const actual = await vi.importActual<typeof import("../../config/sessions/transcript")>(
    "../../config/sessions/transcript",
  );
  return {
    ...actual,
    appendAssistantMessageToSessionTranscript: _mocks.appendAssistantMessageToSessionTranscript,
...
export const whatsappChunkConfig: PowerDirectorConfig = {
