...
import { matchesExecAllowlistPattern } from "./exec-allowlist-pattern";
import type { ExecAllowlistEntry } from "./exec-approvals";
import { resolveDispatchWrapperExecutionPlan } from "./exec-wrapper-resolution";
import { resolveExecutablePath as resolveExecutableCandidatePath } from "./executable-path";
