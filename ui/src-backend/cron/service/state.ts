import type { CronConfig } from "../../config/types.cron";
...
export type CronServiceDeps = {
   ...
   * See: https://github.com/powerdirector/powerdirector/issues/18892
   */
  ...
  runIsolatedAgentJob: (params: {
  ...
  }) => Promise<
    {
       ...
       * https://github.com/powerdirector/powerdirector/issues/15692
       */
      delivered?: boolean;
      /**
