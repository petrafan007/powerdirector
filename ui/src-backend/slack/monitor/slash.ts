...
const SLACK_COMMAND_ARG_ACTION_ID = "powerdirector_cmdarg";
...
let slashCommandsRuntimePromise: Promise<typeof import("./slash-commands.runtime")> | null =
  null;
let slashDispatchRuntimePromise: Promise<typeof import("./slash-dispatch.runtime")> | null =
  null;
let slashSkillCommandsRuntimePromise: Promise<
  typeof import("./slash-skill-commands.runtime")
> | null = null;
...
export async function registerSlackMonitorSlashCommands(params: {
  ...
  let slashCommandsRuntime: typeof import("./slash-commands.runtime") | null = null;
  if (nativeEnabled) {
