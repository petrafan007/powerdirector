...
function mergeSlackAccountConfig(cfg: PowerDirectorConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: PowerDirectorConfig): ResolvedSlackAccount[] {
