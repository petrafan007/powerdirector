...
import { isSupportedNodeVersion } from "../infra/runtime-guard";
import { resolveStableNodePath } from "../infra/stable-node-path";
...
export async function resolvePreferredNodePath(params: {
  ...
  // Prefer the node that is currently running `powerdirector gateway install`.
