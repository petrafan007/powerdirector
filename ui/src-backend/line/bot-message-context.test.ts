...
import { buildLineMessageContext, buildLinePostbackContext } from './bot-message-context';
...
describe("buildLineMessageContext", () => {
  ...
  beforeEach(async () => {
    tmpDir = await fs.mkdtemp(path.join(os.tmpdir(), "powerdirector-line-context-"));
