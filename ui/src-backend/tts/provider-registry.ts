...
import type { SpeechProviderPlugin } from "../plugins/types";
import type { SpeechProviderId } from "./provider-types";
import { buildElevenLabsSpeechProvider } from "./providers/elevenlabs";
import { buildMicrosoftSpeechProvider } from "./providers/microsoft";
import { buildOpenAISpeechProvider } from "./providers/openai";
...
function resolveSpeechProviderPluginEntries(cfg?: PowerDirectorConfig): SpeechProviderPlugin[] {
...
function buildProviderMaps(cfg?: PowerDirectorConfig): {
...
export function listSpeechProviders(cfg?: PowerDirectorConfig): SpeechProviderPlugin[] {
