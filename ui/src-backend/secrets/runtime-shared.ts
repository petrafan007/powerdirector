...
import { coerceSecretRef, type SecretRef } from "../config/types.secrets";
import { secretRefKey } from "./ref-contract";
import type { SecretRefResolveCache } from "./resolve";
...
export type SecretDefaults = NonNullable<PowerDirectorConfig["secrets"]>["defaults"];
