import type { SecretProviderConfig, SecretRef } from "../config/types.secrets";
import { SecretProviderSchema } from "../config/zod-schema.core";
import { isValidExecSecretRefId, isValidSecretProviderAlias } from "./ref-contract";
import { parseDotPath, toDotPath } from "./shared";
import {
...
export type SecretsApplyPlan = {
  ...
  protocolVersion: 1;
  generatedAt: string;
  generatedBy: "powerdirector secrets configure" | "manual";
