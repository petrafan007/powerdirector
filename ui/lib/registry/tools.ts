...
import { ReadFileTool, WriteFileTool, ReplaceFileTool, ListFilesTool } from '../../../src/tools/filesystem';
import { ShellTool } from '../../../src/tools/shell';
import { NotionTool } from '../../../src/tools/notion';
import { GitHubTool } from '../../../src/tools/github';
import { MacProductivityTool } from '../../../src/tools/mac-productivity';
import { HomeAssistantTool } from '../../../src/tools/home-assistant';
import { SpotifyTool } from '../../../src/tools/spotify';
import { BrowserTool } from '../../../src/tools/browser';
import { TwitterTool } from '../../../src/tools/twitter';
import { RedditTool } from '../../../src/tools/reddit';
import { LinkedInTool } from '../../../src/tools/linkedin';
import { VoiceTool } from '../../../src/tools/voice';
import { SystemTool } from '../../../src/tools/system';
import { ImageGenTool } from '../../../src/tools/image-gen';
import { WeatherTool } from '../../../src/tools/weather';
import { OnePasswordTool } from '../../../src/tools/onepassword';
import { GifTool } from '../../../src/tools/gif';
import { TrelloTool } from '../../../src/tools/trello';
import { ObsidianTool } from '../../../src/tools/obsidian';
import { SonosTool } from '../../../src/tools/sonos';
import { ShazamTool } from '../../../src/tools/shazam';
import { EightSleepTool } from '../../../src/tools/eight-sleep';
import { OuraRingTool } from '../../../src/tools/oura-ring';
import { BambuTool } from '../../../src/tools/bambu';
import { GmailTriggerTool } from '../../../src/tools/gmail-triggers';
import { PeekabooTool } from '../../../src/tools/peekaboo';
import { Things3Tool } from '../../../src/tools/things3';
import { BearNotesTool } from '../../../src/tools/bear-notes';
import { TescoTool } from '../../../src/tools/tesco';
import { FoodOrderTool } from '../../../src/tools/food-order';
import { AndroidTool } from '../../../src/tools/android';
import { WindowsTool } from '../../../src/tools/windows';
import { WebSearchTool } from '../../../src/tools/web-search';
import { WebFetchTool } from '../../../src/tools/web-fetch';
import { SubagentsTool } from '../../../src/tools/subagent';
import { SkillTool } from '../../../src/tools/skill';
import { coerceImageGenModelConfig } from '../../../src/tools/image-gen-router';
import { setGlobalSkillsManager } from '../../../src/tools/skill-executor';
import { frigateTool } from '../../../src/tools/frigate';
