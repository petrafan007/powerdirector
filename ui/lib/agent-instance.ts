...
import { DatabaseManager } from '@backend/state/db';
import { SessionManager } from '@backend/state/session-manager';
import { UsageManager } from '@backend/state/usage-manager';
import { Agent } from '@backend/core/agent';
import { Gateway } from '@backend/core/gateway';
import { WebRuntimeServer } from '@backend/core/web-runtime';
import { NodeHostServer } from '@backend/core/node-host';
import { ApprovalsManager } from '@backend/core/approvals';
import { BindingsManager } from '@backend/core/bindings';
import { BroadcastManager } from '@backend/core/broadcast';
import { CanvasHostManager } from '@backend/core/canvas-host';
import { DiagnosticsManager } from '@backend/core/diagnostics';
import { DiscoveryManager } from '@backend/core/discovery';
import { HooksManager } from '@backend/core/hooks';
import { getRuntimeLogger, configureRuntimeLogging } from '@backend/core/logger';
import { MediaManager } from '@backend/core/media';
import { MemoryManager } from '@backend/core/memory';
import { TalkManager } from '@backend/core/talk';
import { UpdateManager } from '@backend/core/update-manager';
import type { TerminalRuntimeOptions } from '@backend/core/terminal';
import { ProviderRouter, Provider } from '@backend/reliability/router';
import { CircuitBreaker } from '@backend/reliability/circuit-breaker';
import { ContextPruner, type ContextPruningConfig } from '@backend/context/pruner';
import { BudgetManager } from '@backend/context/budget';
import { NodeManager } from '@backend/nodes/manager';
import { CronManager, ScheduledTask } from '@backend/scheduling/cron';
import { ToolRegistry } from '@backend/tools/base';
import { AnthropicProvider } from '@backend/providers/anthropic';
import { OpenAIProvider } from '@backend/providers/openai';
import { GeminiProvider } from '@backend/providers/gemini';
import { MinimaxProvider } from '@backend/providers/minimax';
import { OpenAICompatibleProvider } from '@backend/providers/openai-compatible';
import { GeminiCLIProvider, type GeminiCliBackendConfig } from '@backend/providers/gemini-cli';
import { CodexCLIProvider, type CodexCliBackendConfig } from '@backend/providers/codex-cli';
import { PluginsManager } from '@backend/plugins/manager';
import { SkillsManager } from '@backend/skills/manager';
