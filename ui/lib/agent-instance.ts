...
import { DatabaseManager } from '@backend/state/db.js';
import { SessionManager } from '@backend/state/session-manager.js';
import { UsageManager } from '@backend/state/usage-manager.js';
import { Agent } from '@backend/core/agent.js';
import { Gateway } from '@backend/core/gateway.js';
import { WebRuntimeServer } from '@backend/core/web-runtime.js';
import { NodeHostServer } from '@backend/core/node-host.js';
import { ApprovalsManager } from '@backend/core/approvals.js';
import { BindingsManager } from '@backend/core/bindings.js';
import { BroadcastManager } from '@backend/core/broadcast.js';
import { CanvasHostManager } from '@backend/core/canvas-host.js';
import { DiagnosticsManager } from '@backend/core/diagnostics.js';
import { DiscoveryManager } from '@backend/core/discovery.js';
import { HooksManager } from '@backend/core/hooks.js';
import { getRuntimeLogger, configureRuntimeLogging } from '@backend/core/logger.js';
import { MediaManager } from '@backend/core/media.js';
import { MemoryManager } from '@backend/core/memory.js';
import { TalkManager } from '@backend/core/talk.js';
import { UpdateManager } from '@backend/core/update-manager.js';
import type { TerminalRuntimeOptions } from '@backend/core/terminal.js';
import { ProviderRouter, Provider } from '@backend/reliability/router.js';
import { CircuitBreaker } from '@backend/reliability/circuit-breaker.js';
import { ContextPruner, type ContextPruningConfig } from '@backend/context/pruner.js';
import { BudgetManager } from '@backend/context/budget.js';
import { NodeManager } from '@backend/nodes/manager.js';
import { CronManager, ScheduledTask } from '@backend/scheduling/cron.js';
import { ToolRegistry } from '@backend/tools/base.js';
import { AnthropicProvider } from '@backend/providers/anthropic.js';
import { OpenAIProvider } from '@backend/providers/openai.js';
import { GeminiProvider } from '@backend/providers/gemini.js';
import { MinimaxProvider } from '@backend/providers/minimax.js';
import { OpenAICompatibleProvider } from '@backend/providers/openai-compatible.js';
import { GeminiCLIProvider, type GeminiCliBackendConfig } from '@backend/providers/gemini-cli.js';
import { CodexCLIProvider, type CodexCliBackendConfig } from '@backend/providers/codex-cli.js';
import { PluginsManager } from '@backend/plugins/manager.js';
import { SkillsManager } from '@backend/skills/manager.js';
