...
export function listBlueBubblesAccountIds(cfg: PowerDirectorConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: PowerDirectorConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: PowerDirectorConfig): ResolvedBlueBubblesAccount[] {
