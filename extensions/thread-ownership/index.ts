import { definePluginEntry, type PowerDirectorConfig, type PowerDirectorPluginApi } from "./api.js";
...
function resolveOwnershipAgent(config: PowerDirectorConfig): { id: string; name: string } {
