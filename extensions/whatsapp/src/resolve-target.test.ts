import { installCommonResolveTargetErrorCases } from "powerdirector/plugin-sdk/testing";
import { describe, expect, it, vi } from "vitest";

vi.mock("powerdirector/plugin-sdk/whatsapp", async () => {
  const actual = await vi.importActual<typeof import("powerdirector/plugin-sdk/whatsapp")>(
    "powerdirector/plugin-sdk/whatsapp",
  );
