import type { ChannelOnboardingAdapter, PowerDirectorConfig, WizardPrompter } from "powerdirector/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.powerdirector.ai/channels/mattermost",
    ].join("\n"),
...
export const mattermostOnboardingAdapter: ChannelOnboardingAdapter = {
  ...
  disable: (cfg: PowerDirectorConfig) => ({
    ...cfg,
    channels: {
      ...cfg.channels,
