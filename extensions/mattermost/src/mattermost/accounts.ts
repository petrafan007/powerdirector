...
export function listMattermostAccountIds(cfg: PowerDirectorConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: PowerDirectorConfig): string {
...
export function listEnabledMattermostAccounts(cfg: PowerDirectorConfig): ResolvedMattermostAccount[] {
