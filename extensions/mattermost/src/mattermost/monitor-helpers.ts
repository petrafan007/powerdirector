...
export { createDedupeCache, rawDataToString } from "powerdirector/plugin-sdk/mattermost";
...
function listAgents(cfg: PowerDirectorConfig): AgentEntry[] {
...
export function resolveIdentityName(cfg: PowerDirectorConfig, agentId: string): string | undefined {
