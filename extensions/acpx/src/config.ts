...
import type { PowerDirectorPluginConfigSchema } from "../runtime-api.js";
...
function isAcpxPluginRoot(dir: string): boolean {
  return (
    fs.existsSync(path.join(dir, "powerdirector.plugin.json")) &&
...
export function createAcpxPluginConfigSchema(): PowerDirectorPluginConfigSchema {
  return {
