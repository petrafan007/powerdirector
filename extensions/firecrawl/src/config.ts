...
type WebSearchConfig = NonNullable<PowerDirectorConfig["tools"]>["web"] extends infer Web
  ? Web extends { search?: infer Search }
    ? Search
    : undefined
  : undefined;

type WebFetchConfig = NonNullable<PowerDirectorConfig["tools"]>["web"] extends infer Web
...
function resolveSearchConfig(cfg?: PowerDirectorConfig): WebSearchConfig {
...
function resolveFetchConfig(cfg?: PowerDirectorConfig): WebFetchConfig {
...
export function resolveFirecrawlSearchConfig(cfg?: PowerDirectorConfig): FirecrawlSearchConfig {
...
export function resolveFirecrawlFetchConfig(cfg?: PowerDirectorConfig): FirecrawlFetchConfig {
...
export function resolveFirecrawlApiKey(cfg?: PowerDirectorConfig): string | undefined {
...
export function resolveFirecrawlBaseUrl(cfg?: PowerDirectorConfig): string {
  const search = resolveFirecrawlSearchConfig(cfg);
  const fetch = resolveFirecrawlFetchConfig(cfg);
  const configured =
...
export function resolveFirecrawlOnlyMainContent(cfg?: PowerDirectorConfig, override?: boolean): boolean {
...
export function resolveFirecrawlMaxAgeMs(cfg?: PowerDirectorConfig, override?: number): number {
