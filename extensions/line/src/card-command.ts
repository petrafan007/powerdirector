import type { LineChannelData, PowerDirectorPluginApi, ReplyPayload } from "powerdirector/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: PowerDirectorPluginApi): void {
  api.registerCommand({
    name: "card",
