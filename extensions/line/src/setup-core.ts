import type { ChannelSetupAdapter, PowerDirectorConfig } from "powerdirector/plugin-sdk/setup";
import {
  DEFAULT_ACCOUNT_ID,
  listLineAccountIds,
  normalizeAccountId,
...
export function isLineConfigured(cfg: PowerDirectorConfig, accountId: string): boolean {
