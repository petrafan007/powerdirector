...
Nostr DM channel plugin for PowerDirector using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to PowerDirector. It enables your bot to:
...
```bash
powerdirector plugins install @powerdirector/nostr
```
...
# Configure powerdirector to use local relay
