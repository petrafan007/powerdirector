...
type ResolveConfiguredBindingRouteFn =
  typeof import("powerdirector/plugin-sdk/conversation-runtime").resolveConfiguredBindingRoute;
...
describe("registerTelegramNativeCommands — session metadata", () => {
  beforeEach(() => {
    ...
    sessionMocks.resolveStorePath.mockClear().mockReturnValue("/tmp/powerdirector-sessions.json");
