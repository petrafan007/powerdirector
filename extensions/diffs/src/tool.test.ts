...
describe("diffs tool", () => {
  ...
  beforeEach(async () => {
    ({ store, cleanup: cleanupRootDir } = await createDiffStoreHarness("powerdirector-diffs-tool-"));
  });
...
function createApi(): PowerDirectorPluginApi {
  return createTestPluginApi({
    ...
    runtime: {} as PowerDirectorPluginApi["runtime"],
  }) as PowerDirectorPluginApi;
}
