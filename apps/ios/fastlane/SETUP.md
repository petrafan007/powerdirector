# fastlane setup (PowerDirector iOS)
...
ASC_KEYCHAIN_SERVICE=powerdirector-asc-key
...
```bash
ASC_APP_IDENTIFIER=ai.powerdirector.client
# or
...
- The beta flow regenerates `apps/ios/PowerDirector.xcodeproj` from `apps/ios/project.yml` before archiving
