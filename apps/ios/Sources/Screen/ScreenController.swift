...
final class ScreenController {
    ...
    /// Callback invoked when an powerdirector:// deep link is tapped in the canvas
    ...
    func applyHomeCanvasStateIfNeeded() {
        ...
        (() => {
          try {
            const api = globalThis.__powerdirector;
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = PowerDirectorKitResources.bundle
