...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = PowerDirectorLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = PowerDirectorLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.powerdirector.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section {
                    DisclosureGroup(isExpanded: self.$gatewayExpanded) {
                        if !self.isGatewayConnected {
                            Text(
                                "1. Open a chat with your PowerDirector agent and send /pair\n"
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected PowerDirector agent.") { newValue in
                        ...
                        self.featureToggle(
                            ...
                            help: "Allows the gateway to request photos or short video clips "
                                + "while PowerDirector is foregrounded."
                        )
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for PowerDirector. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(PowerDirectorLocationMode.off.rawValue)
                            Text("While Using").tag(PowerDirectorLocationMode.whileUsing.rawValue)
                            Text("Always").tag(PowerDirectorLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while PowerDirector is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("PowerDirector", value: DeviceInfoHelper.powerDirectorVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = PowerDirectorLocationMode(rawValue: newValue) else { return }
                Task {
    ...
    private func friendlyGatewayMessage(from raw: String) -> String? {
        ...
        if lower.contains("pairing required") {
            return "Pairing required. Go back to your PowerDirector chat and run /pair approve, then tap Connect again."
        }
