...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.powerdirector.ios", category: "LiveActivity")
    private var currentActivity: Activity<PowerDirectorActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = PowerDirectorActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<PowerDirectorActivityAttributes>.activities
    ...
    private func updateCurrent(state: PowerDirectorActivityAttributes.ContentState) {
    ...
    private func connectingState() -> PowerDirectorActivityAttributes.ContentState {
        PowerDirectorActivityAttributes.ContentState(
    ...
    private func idleState() -> PowerDirectorActivityAttributes.ContentState {
        PowerDirectorActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> PowerDirectorActivityAttributes.ContentState {
        PowerDirectorActivityAttributes.ContentState(
