...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: PowerDirectorPhotosLatestParams) async throws -> PowerDirectorPhotosLatestPayload {
        ...
        var results: [PowerDirectorPhotoPayload] = []
        ...
        return PowerDirectorPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> PowerDirectorPhotoPayload
    {
        ...
        return PowerDirectorPhotoPayload(
            format: "jpeg",
