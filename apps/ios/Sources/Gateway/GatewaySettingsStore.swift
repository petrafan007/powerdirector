...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.powerdirector.gateway"
    private static let nodeService = "ai.powerdirector.node"
    private static let talkService = "ai.powerdirector.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.powerdirector.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.powerdirector.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("powerdirector-gateway.log")
    }
