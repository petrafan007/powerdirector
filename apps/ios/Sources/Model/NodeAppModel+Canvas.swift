...
extension NodeAppModel {
    func resolveCanvasHostURL() async -> String? {
        ...
        return base.appendingPathComponent("__powerdirector__/canvas/").absoluteString
    }
    ...
    func resolveA2UIHostURL() async -> String? {
        ...
        return base.appendingPathComponent("__powerdirector__/a2ui/").absoluteString + "?platform=ios"
    }
