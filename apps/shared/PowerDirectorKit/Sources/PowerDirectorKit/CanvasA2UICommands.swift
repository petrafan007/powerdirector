...
public enum PowerDirectorCanvasA2UICommand: String, Codable, Sendable {
...
public struct PowerDirectorCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct PowerDirectorCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
