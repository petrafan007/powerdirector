...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: PowerDirectorProtocol.AnyCodable]?
    {
        ...
        return [
            "id": PowerDirectorProtocol.AnyCodable(identity.deviceId),
            "publicKey": PowerDirectorProtocol.AnyCodable(publicKey),
            "signature": PowerDirectorProtocol.AnyCodable(signature),
            "signedAt": PowerDirectorProtocol.AnyCodable(signedAtMs),
            "nonce": PowerDirectorProtocol.AnyCodable(nonce),
        ]
    }
}
