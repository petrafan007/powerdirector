...
private func replaceCanvasCapabilityInScopedHostUrl(scopedUrl: String, capability: String) -> String? {
    let marker = "/__powerdirector__/cap/"
...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.powerdirector", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.powerdirector", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: PowerDirectorProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
