...
public struct PowerDirectorChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct PowerDirectorChatSessionsDefaults: Codable, Sendable {
...
public struct PowerDirectorChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct PowerDirectorChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: PowerDirectorChatSessionsDefaults?
    public let sessions: [PowerDirectorChatSessionEntry]
    ...
    public init(
        ...
        sessions: [PowerDirectorChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
