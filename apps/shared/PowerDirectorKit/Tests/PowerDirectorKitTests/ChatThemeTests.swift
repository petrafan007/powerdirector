...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = PowerDirectorChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = PowerDirectorChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
