...
struct LaunchAgentManagerTests {
    @Test func `launch at login plist does not keep app alive after manual quit`() throws {
        let plist = LaunchAgentManager.plistContents(bundlePath: "/Applications/PowerDirector.app")
        ...
        #expect(args == ["/Applications/PowerDirector.app/Contents/MacOS/PowerDirector"])
    }
}
