...
enum UIStrings {
    static let welcomeTitle = "Welcome to PowerDirector"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "powerdirector.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: PowerDirectorChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g powerdirector@\(version)"
    }
