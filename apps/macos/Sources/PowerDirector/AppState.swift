...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = PowerDirectorConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = PowerDirectorConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            let synced = Self.syncedGatewayRoot(
                currentRoot: PowerDirectorConfigFile.loadDict(),
                connectionMode: connectionMode,
                remoteTransport: remoteTransport,
                remoteTarget: remoteTarget,
                remoteIdentity: remoteIdentity,
            ...
            PowerDirectorConfigFile.saveDict(synced.root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/powerdirector"
        state.remoteCliPath = ""
        return state
    }
}
