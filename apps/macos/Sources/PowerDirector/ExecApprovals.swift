...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.powerdirector", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        PowerDirectorPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        PowerDirectorPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
