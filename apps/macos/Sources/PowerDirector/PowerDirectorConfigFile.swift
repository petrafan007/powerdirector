...
enum PowerDirectorConfigFile {
    private static let logger = Logger(subsystem: "ai.powerdirector", category: "config")
    ...
    static func stateDirURL() -> URL {
        PowerDirectorPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        PowerDirectorPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-powerdirector-config-file",
            "event": "config.write",
