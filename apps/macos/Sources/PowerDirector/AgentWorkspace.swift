...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.powerdirector", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return PowerDirectorConfigFile.defaultWorkspaceURL() }
    ...
    static func defaultTemplate() -> String {
        let fallback = """
        # AGENTS.md - PowerDirector Workspace
