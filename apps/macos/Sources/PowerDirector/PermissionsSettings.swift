    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 14) {
                ...
                Text("Allow these so PowerDirector can notify and capture when needed.")
                    .padding(.top, 4)
...
private struct LocationAccessSettings: View {
    @AppStorage(locationModeKey) private var locationModeRaw: String = PowerDirectorLocationMode.off.rawValue
    ...
    private var locationMode: PowerDirectorLocationMode {
        PowerDirectorLocationMode(rawValue: self.locationModeRaw) ?? .off
    }

    private func requestLocationAuthorization(mode: PowerDirectorLocationMode) async -> Bool {
