...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.powerdirector", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".powerdirector/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.powerdirectorCommand(
            subcommand: "gateway",
