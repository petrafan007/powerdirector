...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.powerdirector", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other PowerDirector windows, but below the system’s pop-up menus.
