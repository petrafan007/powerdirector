...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.powerdirector", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.powerdirector", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [PowerDirectorChatMessage] = messages.compactMap { item in
