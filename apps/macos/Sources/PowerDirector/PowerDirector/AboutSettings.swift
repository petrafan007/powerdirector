...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/powerdirector/powerdirector") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/powerdirector/powerdirector")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://powerdirector.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "PowerDirectorBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "PowerDirectorBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "PowerDirectorGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "PowerDirectorGitCommit") as? String) ??
            "unknown"
    }
