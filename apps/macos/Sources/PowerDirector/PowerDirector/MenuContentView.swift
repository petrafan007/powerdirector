...
/// Menu contents for the PowerDirector menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About PowerDirector") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "PowerDirector Not Configured"
        case .remote:
            "Remote PowerDirector Active"
        case .local:
            "PowerDirector Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .powerdirectorSelectSettingsTab, object: tab)
        }
    }
