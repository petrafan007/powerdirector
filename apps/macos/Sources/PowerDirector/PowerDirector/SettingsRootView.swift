...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .powerdirectorSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? PowerDirectorPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? PowerDirectorPaths.stateDirURL.path
...
extension Notification.Name {
    static let powerdirectorSelectSettingsTab = Notification.Name("powerdirectorSelectSettingsTab")
}
