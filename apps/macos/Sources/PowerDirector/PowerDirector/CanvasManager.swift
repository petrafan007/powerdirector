...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.powerdirector", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("PowerDirector/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__powerdirector__/a2ui/").absoluteString + "?platform=macos"
    }
