...
actor MacNodeRuntime {
    ...
    func handleInvoke(_ req: BridgeInvokeRequest) async -> BridgeInvokeResponse {
        ...
        do {
            ...
            case PowerDirectorBrowserCommand.proxy.rawValue:
            ...
            case PowerDirectorLocationCommand.get.rawValue:
                return try await self.handleLocationInvoke(req)
            case MacNodeScreenCommand.record.rawValue:
                return try await self.handleScreenRecordInvoke(req)
            case PowerDirectorSystemCommand.run.rawValue:
                return try await self.handleSystemRun(req)
            case PowerDirectorSystemCommand.which.rawValue:
                return try await self.handleSystemWhich(req)
            case PowerDirectorSystemCommand.notify.rawValue:
                return try await self.handleSystemNotify(req)
            case PowerDirectorSystemCommand.execApprovalsGet.rawValue:
                return try await self.handleSystemExecApprovalsGet(req)
            case PowerDirectorSystemCommand.execApprovalsSet.rawValue:
    ...
    private func handleA2UIInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        ...
        case PowerDirectorCanvasA2UICommand.push.rawValue,
             PowerDirectorCanvasA2UICommand.pushJSONL.rawValue:
    ...
    private func handleBrowserProxyInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        guard PowerDirectorConfigFile.browserControlEnabled() else {
            return BridgeInvokeResponse(
                id: req.id,
                ok: false,
                error: PowerDirectorNodeError(
    ...
    private func resolveA2UIHostUrl() async -> String? {
        ...
        return baseUrl.appendingPathComponent("__powerdirector__/a2ui/").absoluteString + "?platform=macos"
    }
    ...
    private func handleSystemRun(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(PowerDirectorSystemRunParams.self, from: req.paramsJSON)
    ...
    private func handleSystemWhich(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(PowerDirectorSystemWhichParams.self, from: req.paramsJSON)
    ...
    private func resolveSystemRunApproval(
        ...
        params: PowerDirectorSystemRunParams,
...
extension MacNodeRuntime {
    ...
    private nonisolated static func locationMode() -> PowerDirectorLocationMode {
    ...
    private static func errorResponse(
        ...
        code: PowerDirectorNodeErrorCode,
        message: String) -> BridgeInvokeResponse
    {
        BridgeInvokeResponse(
            id: req.id,
            ok: false,
            error: PowerDirectorNodeError(code: code, message: message))
    }

    private static func encodeCanvasSnapshot(
        image: NSImage,
        format: PowerDirectorCanvasSnapshotFormat,
        maxWidth: Int?,
