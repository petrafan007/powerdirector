## PowerDirector Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_powerdirector-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
powerdirector nodes pending
powerdirector nodes approve <requestId>
```
