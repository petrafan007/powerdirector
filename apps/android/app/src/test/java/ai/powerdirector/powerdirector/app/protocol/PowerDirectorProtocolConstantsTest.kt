...
class PowerDirectorProtocolConstantsTest {
  ...
  fun capabilitiesUseStableStrings() {
    ...
    assertEquals("callLog", PowerDirectorCapability.CallLog.rawValue)
  }
  ...
  fun callLogCommandsUseStableStrings() {
    assertEquals("callLog.search", PowerDirectorCallLogCommand.Search.rawValue)
  }

  @Test
  fun smsCommandsUseStableStrings() {
    assertEquals("sms.search", PowerDirectorSmsCommand.Search.rawValue)
  }
}
