...
import ai.powerdirector.app.ui.mobileAccentBorderStrong
...
import ai.powerdirector.app.ui.mobileSurface
import ai.powerdirector.app.ui.mobileText
import ai.powerdirector.app.ui.mobileTextSecondary
import ai.powerdirector.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.powerdirector.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.powerdirector.app.ui.mobileFontFamily,
