...
import ai.powerdirector.app.voice.VoiceConversationRole
  ...
  Row(
    ...
    Surface(
      ...
      Column(
        ...
        Text(
          if (isUser) "You" else "PowerDirector",
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Row(
        ...
        Text("PowerDirector is thinking…", style = mobileCallout, color = mobileTextSecondary)
      }
    }
  }
}
