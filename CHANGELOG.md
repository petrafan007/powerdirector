...
- **[Hotfix 13]**: Improved LLM reliability by treating empty responses as recoverable failures; implemented auto-fallback and retry logic in the core agent and provider router to prevent "empty response" errors from halting chat sessions. (2026-03-14)
